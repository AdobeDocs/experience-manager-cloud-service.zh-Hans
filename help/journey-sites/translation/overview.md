...
# AEM Site 翻译历程 {#aem-sites-translation-journey}

从这里开始，通过使用 AEM 强大的翻译工具来翻译您的 AEM Site 内容，实施引导式历程。
...
此历程专为翻译专家角色（通常称为翻译项目经理 (TPM)）设计。此历程列出了翻译 AEM Site 内容的要求、步骤和方法。此历程可能会定义翻译专家必须与之交互的其他角色，但历程的观点是翻译专家的观点。
...
| 内容作者 | 创建和管理作为 Site 交付的内容 | 内容作者创建翻译专家必须翻译的内容。 |
...
|---|---|---|
| 0 | AEM Site 翻译历程 | 本文档 |
| 1 | [了解 AEM 中的 Site 内容和翻译方法](learn-about.md) | 了解 Site 概念和 AEM 翻译理论。 |
| 2 | [AEM Site 翻译快速入门](getting-started.md) | 了解如何组织您的 Site 内容以及 AEM 的翻译工具的工作原理。 |
| 3 | [配置翻译连接器](configure-connector.md) | 了解如何将 AEM 连接到翻译服务。 |
| 4 | [配置翻译规则](translation-rules.md) | 了解如何定义翻译规则，标识要翻译的内容。 |
| 5 | [翻译内容](translate-content.md) | 使用翻译连接器和规则来翻译 Site 内容。 |
