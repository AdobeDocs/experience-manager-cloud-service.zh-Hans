...
1. 导航到&#x200B;**导航** -> **项目**。
1. 点按或单击上一部分中创建的项目（[根据内容路径自动创建翻译项目](#automatically-creating)或[通过选择内容来手动创建翻译项目](#manually-creating)，具体取决于您所处的情况）。
...
1. 点击或单击行项的选择复选框可查看更多选项，例如，从作业中删除行项或在“站点”控制台中查看行项的选项。
...
点按或单击该图标可在其控制台中打开已翻译内容，查看已翻译内容的详细信息。

![已翻译页面](assets/translated-page.png)

如果您有适当的权限，则可进一步修改必要的翻译内容，但编辑内容超出了此历程的范围。请参阅 [其他资源](#additional-resources) 部分，以了解有关此主题的更多信息。
...
请务必了解一点，由于此内容未发布，因此不可供使用。我们将了解此创作-发布结构，以及如何在翻译历程的下一步发布我们的已翻译内容。

## 人工翻译 {#human-translation}

如果您的翻译服务提供人工翻译，则审查流程会提供更多选项。例如，翻译以&#x200B;**草稿**&#x200B;状态返回项目中，并且必须手动审查和批准或拒绝翻译。

人工翻译超出了此本地化历程的范围。请参阅 [其他资源](#additional-resources) 部分，以了解有关此主题的更多信息。 不过，除了其他审批选项之外，人工翻译的工作流与此历程中描述的机器翻译相同。
