...
AEM 是用于创建和管理数字体验的强大工具集。内容作者可以使用站点编辑器轻松创建数字体验，并使用站点控制台组织内容，同时能够实时查看AEM跨渠道交付给受众的内容。
...
* **如果您是AEM的新用户**，遵循此历程是在功能齐全的实际AEM环境中启动并运行真实内容的最简单方法，以便您测试功能并了解AEM的功能。
...
此历程列出了使用 AEM 参考演示加载项（包括 Sites 和/或 Screens 演示内容）创建新项目和设置 AEM 沙盒的要求、步骤和方法。其主要受众是 Cloud Manager 中分配了&#x200B;**业务负责人**&#x200B;角色的&#x200B;**系统管理员**。通常，此系统管理员还负责管理环境。但是，安装参考演示加载项后，该管理员可以向其他用户授予对AEM环境的访问权限，以测试已由加载项启用的功能。
