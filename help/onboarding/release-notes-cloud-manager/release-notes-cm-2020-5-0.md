---
title: AEM as a Cloud Manager版本2020.5.0的发行说明
description: AEM as a Cloud Manager版本2020.5.0的发行说明
feature: 发行信息
...
# Adobe Experience Manager as a Cloud Service2020.5.0 {#release-notes}中的Cloud Manager发行说明

本页面概述了AEM as a Cloud 2020.5.0中的Cloud Manager发行说明。

## 发布日期 {#release-date}

AEM as a Cloud Service2020.5.0中的Cloud Manager的发布日期是2020年5月7日。
