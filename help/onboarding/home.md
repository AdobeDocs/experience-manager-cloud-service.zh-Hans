...
# Experience Manager 云服务入门 {#aem-onboarding-guide}

本页列出了有关 Experience Manager 云服务入门的自助资源。

## 关键入门文章 {#key-articles}

此部分涵盖有关以下内容的关键文章：

* 访问 Experience Manager 云服务的要求
* 了解控制特定功能可用性的用户角色
* 设置 Cloud Manager git 存储库
* 访问 Experience Manager 云服务
* 数据保护和隐私法规的基础知识
...
| [迁移到 AEM 云服务](/help/move-to-cloud-service/home.md) | 了解过渡到Cloud Service |
