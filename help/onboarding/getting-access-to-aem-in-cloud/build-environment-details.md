...
# 了解Build环境{#understanding-build-environment}

## 生成环境详细信息{#build-environment-details}
...
* Maven在系统级别上配置了settings.xml文件，该文件使用名为`adobe-public`的Adobe自动包括公用用户档案&#x200B;**Artifact**&#x200B;存储库。 (有关更多详细信息，请参阅[Adobe公共主存储库](https://repo.adobe.com/))。
