...
如果您不熟悉此页面上使用的所有术语，请不要担心。 这些术语会在历程的下一部分进行解释。
...
加入 AEM as a Cloud Service，首先需要您的组织与 Adobe 签订合同。 原因是合同规定了Adobe与您的组织之间的一些重要协议，例如：
...
电子邮件包含有关如何开始使用 Experience Cloud 服务、Cloud Manager 自助式门户的详细信息。 此外，该电子邮件还包含重要信息，例如从何处获取支持资源、论坛、常见问题解答等。 在该电子邮件中提供的资源列表中，您还将获得有关如何访问 AEM 云环境的详细信息。
