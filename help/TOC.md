...
+ AEM as a Cloud Service 迁移历程 {#migration-journey}
   ...
   + 迁移工具的发行说明 {#release-notes-migration-tools}
      + [最新发行说明（2022.4.0 版）](/help/journey-migration/release-notes/release-notes-migration-tools-current.md)
...
+ 资源 {#assets}
   ...
   + Dynamic Media {#dynamicmedia}
      + Dynamic Media历程 {#dm-journey}
         + [基础知识，第一部分](/help/assets/dynamic-media/dm-journey-part1.md)
         + [第二部分基本内容](/help/assets/dynamic-media/dm-journey-part2.md)
