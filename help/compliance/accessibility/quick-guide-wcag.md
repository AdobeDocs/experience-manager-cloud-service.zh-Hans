...
* 支持&#x200B;**优先实施和上下文实施：**
WCAG 2.1 准则被赋予优先权，其中涉及不遵循准则对特定残障用户群体可能产生的影响。这使得作者能够针对特定情况根据最重要的准则做出明智的决策。此外，还引入了“支持无障碍”**&#x200B;的概念。这允许作者决定如何更好地使用可能没有完全无障碍支持，或可能要求用户具有特定辅助技术和浏览器的Web技术，或同时具有这两种技术才能从无障碍功能中受益。
...
* A *充分技术* 是一个成功标准，如果遵循，则足以满足特定的成功标准。
...
每个准则和成功标准也都有一个自己的“了解”页面，其中提供有关以下项的信息：

* 准则的目的；
* 具体成功标准；
* 建议技术，可帮助满足准则的要求，但不属于任何特定成功标准。

每个成功标准各自的“了解”页面提供有关以下项的信息：
...
“如何达到标准”部分可在 [如何满足WCAG 2.1](https://www.w3.org/WAI/WCAG21/quickref/) 页面。 本节提供了 WCAG 的替代形式，允许读者根据与自身兴趣和/或情况最相关的准则优化内容。读者可以通过指定特定 Web 内容技术（如层叠样式表或脚本）或指定特定优先级来筛选他们希望查看的成功标准技术。
