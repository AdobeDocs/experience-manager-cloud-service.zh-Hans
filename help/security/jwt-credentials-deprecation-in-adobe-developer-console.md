...
目前主要重点是 AEM 功能尚不支持新的 OAuth 服务器到服务器凭据。我们很快便会提供支持，届时会在 2024 年 4 月中旬前通过 AEM as a Cloud Service 的 AEM 版本提供。您可能已经收到一封电子邮件，其中包含迁移 JWT 凭据的说明，但请放心，您可以且应该推迟凭据迁移，直到 AEM 支持新的 OAuth 服务器到服务器凭据类型。
