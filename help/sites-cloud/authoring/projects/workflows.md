...
>[!NOTE]
>
>&amp;ast;这些工作流不是从 **工作流** 拼贴。 请参阅[为资产创建语言副本](/help/sites-cloud/administering/translation/managing-projects.md)。
...
1. 单击&#x200B;**创建**。该工作流随即会启动。工作流将显示在 **工作流** 列表（单击省略号） **...** 在 **工作流** 拼贴以访问此列表)。

## 为资产创建（和翻译）语言副本工作流 {#create-and-translate-language-copy-workflow-for-assets}

的 **创建语言副本** 和 **创建和翻译语言副本** 工作流在 [为资产创建语言副本。](/help/assets/translate-assets.md)
