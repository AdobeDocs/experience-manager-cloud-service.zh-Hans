...
在ContextHub中名为&#x200B;*segment*&#x200B;的受众是由特定条件定义的访客类，然后由特定条件确定哪些人可以看到目标活动。 定位活动时，您可以直接在“定位”过程中选择受众，也可以在“受众”控制台中创建新受众。

在“受众”控制台中，各受众按品牌进行组织。

受众在“定位”模式下可用于[创作目标内容](/help/sites-cloud/authoring/personalization/targeted-content.md)，在该模式下，您还可以创建受众(但您需要在“受众”控制台中创建Adobe Target受众)。 在“定位”模式下创建的受众会显示在“受众”控制台中。
...
| **浏览器** | 您可以目标在用户访问您的页面时使用特定浏览器或特定浏览器选项的用户。 | 请参阅位于Adobe Target的[浏览器选项文档](https://docs.adobe.com/help/en/target/using/audiences/create-audiences/categories-audiences/browser.html)。 |
