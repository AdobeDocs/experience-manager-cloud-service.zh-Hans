...
通过“活动”控制台，您可以创建、组织和管理营销 [活动](/help/sites-cloud/authoring/personalization/overview.md#activities) 您的品牌：
...
在“定位”模式下，可以使用活动来[创作目标内容](/help/sites-cloud/authoring/personalization/targeted-content.md)，您也可以在该模式下创建活动。在“定位”模式下创建的活动将显示在“活动”控制台中。
...
1. 如果您将Adobe Target用作定位引擎，请选择要通过此活动衡量的指标。 请参阅[配置活动和设置目标](/help/sites-cloud/authoring/personalization/targeted-content.md)，以了解有关可用成功量度的更多信息。您必须至少选择一个目标。
1. 单击或点按 **保存**.
