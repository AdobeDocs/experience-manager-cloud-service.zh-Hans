...
1. 选择要为其创建活动的品牌，然后选择 **创建** 则 **创建活动**. 如果进行编辑，请在“主区域”屏幕中选择活动，然后单击或点按&#x200B;**编辑活动**。
1. 提供以下信息，然后选择 **下一个**：
   * 活动的名称。
...
1. 在 **个性化**，选择 **活动** 导航到 **活动** 控制台。
1. 选择要查看其活动的品牌。
1. 选择活动并选择 **查看属性** 然后单击 **报表** 选项卡，然后选择要查看其入选体验的性能/转化入选体验的活动。 显示性能数据。

   ![查看活动业绩](/help/sites-cloud/authoring/assets/activities-performance.png)

1. 选择 **推送入选方** 链接以将该体验推送为默认体验。
...
1. 选择 **是** 要确认是否想要转换入选体验，请禁用当前体验并将其替换为入选体验的内容。
