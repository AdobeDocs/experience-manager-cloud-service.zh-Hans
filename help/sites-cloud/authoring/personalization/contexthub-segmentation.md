...
AEM 可让您轻松个性化用户体验。它还让您验证区段定义的结果。
...
1. 选择&#x200B;**创建**&#x200B;按钮并选择&#x200B;**创建ContextHub区段**。

   ![添加区段](../assets/contexthub-create-segment.png)

1. 在&#x200B;**新ContextHub区段**&#x200B;中，根据需要输入区段的标题和Boost值，然后选择&#x200B;**创建**。
...
1. 在[访问区段](#accessing-segments)后，选择&#x200B;**创建**&#x200B;按钮并选择&#x200B;**文件夹**。
...
1. 在[访问区段](#accessing-segments)后，选择要修改的文件夹以将其选定。

   ![选择文件夹](../assets/contexthub-select-folder.png)

1. 在工具栏中选择&#x200B;**重命名**&#x200B;以重命名文件夹。
