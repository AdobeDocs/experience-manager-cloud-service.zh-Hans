...
1. 要添加体验，请选择 **+** **添加体验定位** 显示在中现有体验的下方 **受众** 窗格。
...
1. 从库中选择选件，然后选择复选标记图标。
   ...
   * 选择 **浏览** 以导航到其他文件夹。 导航窗格随即会打开，单击箭头可向下浏览文件夹。选择 **浏览** 再次关闭导航窗格。

   ![浏览内容](../assets/targeted-select-content-browse.png)

   * 选择 **筛选** 根据关键字或标记筛选选件。 可输入关键字，并从下拉菜单中选择标记。选择 **筛选** 以关闭筛选窗格。
...
1. 如果您希望更好地控制成功量度的计数方式，请选择 **高级设置** 来访问这些文件。
1. 单击&#x200B;**保存**。
