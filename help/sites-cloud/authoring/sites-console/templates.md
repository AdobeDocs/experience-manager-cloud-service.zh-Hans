...
1. 现在，您可以在以下情况下使用模板： [创建页面](/help/sites-cloud/authoring/sites-console/creating-pages.md#creating-a-new-page)，但您可能希望 [编辑模板](#editing-templates-template-authors) 根据您的要求。
...
请参阅 [样式系统文档](/help/sites-cloud/authoring/page-editor/style-system.md) 以了解更多信息。
...
>[!NOTE]
>
>将组件和资产添加到模板的操作与类似的操作虽然并不完全相同，但也存在许多相似之处， [页面创作。](/help/sites-cloud/authoring/page-editor/edit-content.md)
