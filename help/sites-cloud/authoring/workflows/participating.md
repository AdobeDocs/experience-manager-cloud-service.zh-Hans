...
* 当您使用页面编辑器时，状态栏将显示：
   ...
   * 页面需执行的工作流数量。您可以：
      ...
      * 选择实际编号以打开所有适用工作流的下拉列表，然后选择要显示在状态栏中的工作流。
...
* 当打开资源的&#x200B;**时间轴**&#x200B;时，会显示工作流步骤。在警报横幅上选择时，也会显示可用的操作：
...
1. 从工具栏中选择&#x200B;**完成**。
1. **完成工作项**&#x200B;对话框打开。 从下拉选择器中选择&#x200B;**下一步**，并根据需要添加&#x200B;**注释**。
...
如果某个步骤已分配给您，但由于任何原因您无法操作，则可以将该步骤委派给其他用户或组。
...
如果您发现某个步骤或一系列步骤必须重复，则可以回退。 此操作让您选择之前已在工作流中执行过的步骤，以进行重新处理。工作流会返回到您指定的步骤，然后从此处继续执行。
