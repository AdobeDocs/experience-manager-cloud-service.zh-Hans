...
创建页面时，必须选择一个模板，该模板用作创建新页面的基础。 模板定义了生成页面的结构、任何初始内容以及可以使用的组件。
...
>[!CAUTION]
>
>启用模板后，当模板作者开始进一步更新模板时，会显示警告。 这是为了告知用户可能会引用该模板，因此任何更改都可能影响引用该模板的页面。
...
>[!CAUTION]
>
>如果作者开始编辑已启用的模板，则会显示警告。 这是为了告知用户可能会引用该模板，因此任何更改都可能影响引用该模板的页面。
