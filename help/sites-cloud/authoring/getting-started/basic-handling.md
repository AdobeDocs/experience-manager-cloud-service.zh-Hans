...
| 资产 | 通过“资产”控制台，您可以导入和管理 [图像、视频、文档和音频文件等数字资产](/help/assets/overview.md). 随后，这些资产便可由同一 AEM 实例上运行的任何站点使用。您还可以创建和管理 [内容片段](/help/assets/content-fragments/content-fragments.md) 从“资产”控制台。 |
...
例如，在 **站点** 控制台中，您可以选择仅限内容（默认）、内容树、时间轴、引用、网站详细信息或过滤器侧面板。
...
**网站** 显示网站的详细信息 [使用站点模板创建。](/help/sites-cloud/administering/site-creation/create-site.md)
...
>[!TIP]
>
>有关从模板创建新站点及自定义其主题的过程的端到端描述，请参阅 [快速创建网站历程。](/help/journey-sites/quick-site/overview.md)
