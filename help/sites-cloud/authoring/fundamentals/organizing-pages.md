...
在 AEM 中，模板可指定特定类型的页面。模板用作正在创建的任何新页面的基础。
...
1. 导航到要创建新页面的位置。
1. 使用以下方式打开下拉选择器 **创建** 在工具栏中，然后选择 **页面** 从列表中：
...
1. 在向导的最后一步中，您可以执行以下操作之一：
   ...
   * **名称**：
      ...
      * 您在&#x200B;**名称**&#x200B;字段中&#x200B;**无法提交无效的字符**。当AEM检测到无效字符时，该字段会高亮显示，并显示一条说明性消息，指示需要删除/替换的字符。
...
>[!NOTE]
>
>有关异步作业处理以及如何配置页面移动/重命名操作限制的更多信息，请参阅 [异步作业](/help/operations/asynchronous-jobs.md) 操作用户指南中的文档。
