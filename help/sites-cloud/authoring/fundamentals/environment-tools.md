...
适当的资源(例如 **站点** 控制台中的资产 **资产** 控制台) [时间轴可用于显示任何选定项目上的近期活动](/help/sites-cloud/authoring/getting-started/basic-handling.md#timeline).
...
>* 有 [键盘快捷键](/help/sites-cloud/authoring/getting-started/keyboard-shortcuts.md) ( `Ctrl-Shift-M`)切换 **预览** 和当前选定的模式(例如， **编辑**, **布局**&#x200B;等)。
>
