...
1. 在&#x200B;**编辑配置**&#x200B;窗口中，配置&#x200B;**站点**&#x200B;和&#x200B;**资源**&#x200B;选项卡上的属性，然后单击或点按&#x200B;**保存并关闭**。

### 站点配置属性 {#sites-configuration-properties}

**Sites**&#x200B;选项卡控制如何执行页面内容的翻译。
...
资源属性控制如何配置资源。有关翻译资源的更多信息，请参阅[创建资源的语言副本](/help/assets/translate-assets.md)。
...
1. 在 Sites 控制台中，选择要配置的页面，然后单击或点按&#x200B;**查看属性**。
1. 单击或点按&#x200B;**云服务**&#x200B;选项卡。
1. 在&#x200B;**添加配置**&#x200B;下拉列表中选择配置。
1. 单击或点按&#x200B;**保存并关闭**。
