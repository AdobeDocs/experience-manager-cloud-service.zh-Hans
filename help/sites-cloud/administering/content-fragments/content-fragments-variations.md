---
title: 变体 – 创作片段内容
description: 了解变体如何让您为片段创作内容，然后根据用途创建该内容的变体。 这为 headless 投放和页面创作增加了灵活性。
...
[变体](/help/sites-cloud/administering/content-fragments/content-fragments.md#constituent-parts-of-a-content-fragment) 是Adobe Experience Manager (AEM)内容片段的一项重要功能。 它们允许您创建和编辑主控内容的副本，以供在特定渠道和场景中使用，从而使页面创作和headless内容投放更加灵活。
...
当您打开内容片段进行编辑时，**变体**&#x200B;选项卡会默认打开。在此，您可以为主要或任何变体创作内容。结构化片段包含在内容模型中定义的各种数据类型的字段。
...
>[!NOTE]
>
>有关完整信息，请参阅 [Markdown](/help/sites-cloud/administering/content-fragments/content-fragments-markdown.md).
...
1. 关闭全屏编辑器时，注释仍会高亮显示。如果选中，将打开一个对话框，以便您能够进一步编辑注释。
...
* 在编辑器的全屏和正常模式下，由文本上的高亮显示指示。 然后，可通过单击高亮显示的文本来查看、编辑或删除注释的完整详细信息，此时将重新打开对话框。
...
* 可在以下位置查看和删除它们： [时间线](/help/sites-cloud/administering/content-fragments/content-fragments-managing.md#timeline-for-content-fragments) 所选片段的。
