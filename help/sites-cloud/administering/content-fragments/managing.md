...
* 左侧面板
   ...
   * 您可以选择树的特定分支
   * 可以调整其大小以显示嵌套文件夹
   * 您可以在查看内容片段或[Assets](/help/sites-cloud/administering/content-fragments/assets-content-fragments-console.md)之间进行选择
* 主/右侧面板 – 从此处，您可以：
   * 查看树的选定分支中的所有内容片段列表：
...
* **语言**：表示任何[语言](#language-copies-fragment)副本
...
两者都提供一个链接，该链接打开一个对话框，其中列出该片段的所有父引用，包括引用内容片段、体验片段和页面。要打开特定引用，请单击对话框中的&#x200B;**标题**&#x200B;或链接图标。
