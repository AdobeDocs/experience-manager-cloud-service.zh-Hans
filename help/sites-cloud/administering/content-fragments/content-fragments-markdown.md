---
title: Markdown
description: 了解内容片段编辑器如何使用Markdown语法，以便轻松地为页面创作和无标题交付创建内容。
...
当您 [创作](/help/sites-cloud/administering/content-fragments/content-fragments-variations.md#authoring-your-content)，内容片段编辑器使用 *markdown* 使您能够轻松编写内容以用于页面创作和无标题交付的语法：

![markdown编辑器](/help/sites-cloud/administering/content-fragments/assets/cfm-markdown-01.png)
...
代码块通常用于说明源代码。 您可以通过使用制表符缩进代码，或者最少4个空格来创建代码块。 例如：
...
您可以使用反斜杠转义生成在格式语法中具有特殊含义的文字字符。 例如，如果您想要在单词周围加上文字星号(而不是HTML标记)，则可以在星号前使用反斜杠，如下所示：
