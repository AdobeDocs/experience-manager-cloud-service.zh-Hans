...
* 描述访客体验质量的[Core Web Vitals (CWV)](https://web.dev/articles/lcp)性能指标[最大内容绘制(LCP)](https://web.dev/articles/lcp)、[交互到下一绘制(INP)](https://web.dev/articles/inp)和[累积布局偏移(CLS)](https://web.dev/articles/cls)。
