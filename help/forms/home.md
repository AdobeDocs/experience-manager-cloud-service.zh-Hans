...
![数据收集 — 响应式表单设计](/help/forms/assets/data-collection.jpeg "适用于多个设备的自适应Forms体验"){width="70%" align="center"}
...
![个性化通信 — 响应式设计](/help/forms/assets/personalized-communication.jpeg "按需生成的个性化PDF发票"){width="70%" align="center"}
