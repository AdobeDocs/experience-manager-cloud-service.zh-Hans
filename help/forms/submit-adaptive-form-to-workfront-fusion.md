...
1. 输入&#x200B;**实例URL**。
   ...
   您可以从创建连接所需的开发人员控制台[&#128279;](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-with-aem-headless/authentication/service-credentials.html?lang=zh-Hans)检索服务凭据。
