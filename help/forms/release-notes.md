...
- **Analytics for Adaptive Forms**：您现在可以通过 Adobe Analytics for Adaptive Forms 捕获和跟踪已登录和未登录（匿名）的行为，从而收集用户洞察。这有助于根据数据做出明智的决策，从而改善用户体验。
...
- **Analytics for Adaptive Forms**：您现在可以[通过 Adobe Analytics for Adaptive Forms 捕获和跟踪用户行为](integrate-aem-forms-with-adobe-analytics.md)，从而收集用户洞察。这有助于根据数据做出明智的决策，从而改善用户体验。
...
- **Analytics for Adaptive Forms**：您现在可以通过 Adobe Analytics for Adaptive Forms 捕获和跟踪用户行为，从而收集用户洞察。这有助于根据数据做出明智的决策，从而改善用户体验。
