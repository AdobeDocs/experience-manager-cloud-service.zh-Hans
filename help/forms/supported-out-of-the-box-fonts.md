---
title: AEM Forms as a Cloud Service支持用于PDF生成的现成字体。
description: AEM Forms as a Cloud Service支持用于记录文档和PDF的现成字体。
...
* To generate Document of Record to archive AEM forms and content together in PDF format ([Click to know more](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/forms/adaptive-forms-authoring/authoring-adaptive-forms-foundation-components/generate-document-of-record-for-non-xfa-based-adaptive-forms)).
-->
...
除了上述字体外，您还可以使用自定义字体为PDF提供特定外观。 要启用自定义字体，请使用有效许可证[将自定义字体添加到Forms as a Cloud Service环境](/help/forms/use-custom-fonts.md)。
