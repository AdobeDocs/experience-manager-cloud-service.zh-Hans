...
1. 为读取服务参数选择![aem_6_3_edit](assets/edit.svg)以将参数绑定到用户配置文件属性、请求属性或文本值[，并指定绑定值。](#bindargument)
...
>[!NOTE]
>
>**[!UICONTROL NavigationPropertyName]**&#x200B;参数的&#x200B;**默认值**&#x200B;字段中可用的值取决于&#x200B;**[!UICONTROL 返回数组的状态？]**&#x200B;切换按钮。 启用后，它将显示收藏集类型的导航属性。
