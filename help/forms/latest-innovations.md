...
| 新一代可组合性 | 借助新一代可组合性，企业内的员工可以在他们的首选工具(如Microsoft Excel和Google Sheets)中创建表单，而无需进行关于新UI工作流的全面培训。 <br/> <br/> 此外，新一代可组合性设计用于以无与伦比的速度加载表单，在实时页面上获得近乎完美的Google Lighthouse分数，从而保证出众的性能和用户体验。<br/> <br/> ![用于创建表单的新一代可组合性工具](/help/forms/assets/web-vitals.jpeg) 此外，由于新一代可组合性提供的简单工具，表单的部署从未像现在这样轻松或快速。 只需最少的开发时间，您就可以轻松地简化上线的路径，并为客户提供卓越的外观体验。 |
