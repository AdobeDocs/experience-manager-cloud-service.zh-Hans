...
1. 在 **[!UICONTROL 开发]** 部分，点按 ![更多选项](assets/more-options-icon.svg) 然后点击 **[!UICONTROL 批准并发布到生产环境]**.
...
1. 点按 ![可视化图表](assets/visualization-icon.svg) 并将图表类型拖放到“自由格式”部分。 同样，可以向自由格式部分添加多个图表类型。
