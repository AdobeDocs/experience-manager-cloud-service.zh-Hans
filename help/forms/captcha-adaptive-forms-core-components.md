...
1. 配置Cloud Service：
   ...
   1. 指定 **[!UICONTROL 标题]**， **[!UICONTROL 名称]**， **[!UICONTROL 站点密钥]**、和 **[!UICONTROL 密钥]** reCAPTCHA服务（在步骤1中获取）。 选择&#x200B;**[!UICONTROL 创建]**。
...
1. 选择自适应Forms并选择 **[!UICONTROL 属性]**. 对于 **[!UICONTROL 配置容器]** 选项，选择配置容器，其中包含通过Google将AEM Forms与reCAPTCHA服务连接的云配置，然后选择 **[!UICONTROL 保存并关闭]**.
...
1. 选择 **[!UICONTROL 自适应表单reCAPTCHA]** 组件并选择属性 ![“属性”图标](assets/configure-icon.svg) 图标。 此时将打开“属性”对话框。 指定以下必需属性：
