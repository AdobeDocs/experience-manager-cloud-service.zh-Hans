...
>[!NOTE]
>
>**主题名称：**&#x200B;当您将Forms主题嵌入站点主题并通过前端管道进行部署时，**无需更改任何主题名称**。 表单样式将成为现有站点主题的一部分，该主题将以其当前名称构建和部署。 仅当从专用主题存储库部署`package.json`独立&#x200B;**Forms主题时，才需要更改主题名称（例如**&#x200B;中的）；此方案在[使用主题为基于核心组件的自适应Forms设置样式](/help/forms/using-themes-in-core-components.md)中介绍。
