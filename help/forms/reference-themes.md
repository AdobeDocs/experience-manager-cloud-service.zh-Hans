...
[主题](/help/forms/themes.md) 允许您在不深入了解CSS的情况下设置表单样式。 除了默认主题之外，您还可以通过安装 [AEM Forms附加组件包](https://experienceleague.adobe.com/docs/experience-manager-release-information/aem-release-updates/forms-updates/aem-forms-releases.html?lang=en):
...
![执行主题](/help/forms/assets/exec.png)
...
![执行灯主题](/help/forms/assets/exec-light.png)
...
![自由主题](/help/forms/assets/liberty.png)
<!--[Click to enlarge
...
![美国Web设计标准主题](/help/forms/assets/us-web-standards.png)
<!--[Click to enlarge
