...
# 使用AEM Formsas a Cloud Service*通信 {#frequently-asked-questions}

**AEM Formsas a Cloud Service*通信功能处于测试阶段。**
...
通常，您使用Designer创建模板，然后使用通信API将数据与模板合并。 您的应用程序可以将输出文档发送到网络打印机、本地打印机或存储系统以进行存档。 典型的开箱即用工作流和自定义工作流如下所示：
...
&lt;!-* *Acrobat表单不支持PDF版本和标记PDF等运行时选项。 它们适用于包含XFA流的PDF forms;但是，这些表单无法签名或认证。

### 电子邮件支持 {#email-support}

对于电子邮件功能，您可以在使用电子邮件步骤的Experience Manager工作流中创建一个流程。 工作流表示您正在实现自动化的业务流程。 —>
...
通信API使用XCI配置文件来执行任务，例如控制输出是单个面板还是分页。 尽管此文件包含可设置的设置，但修改此值并不是典型操作。 &lt;!-* default.xci文件位于svcdata\XMLFormService文件夹中。 —>
...
| XCI选项 |描述 | | —* | —* | |配置/存在/pdf/creator |使用“文档信息”词典中的“创建者”条目标识文档创建者。 有关该词典的信息，请参阅PDF参考指南。                                                                                                                                                                                                                                                                                                                                         | |配置/存在/pdf/producer |使用“文档信息”词典中的“制作者”条目标识文档制作者。 有关该词典的信息，请参阅PDF参考指南。                                                                                                                                                                                                                                                                                                                                       | |配置/存在/布局 |控制输出是单个面板还是分页。                                                                                                                                                                                                                                                                                                                                                                                                                                                 | |配置/存在/pdf/压缩/级别 |指定在生成PDF文档时要使用的压缩程度。                                                                                                                                                                                                                                                                                                                                                                                                                                  | | config/present/pdf/scriptModel |控制输出PDF文档中是否包含特定于XFA的信息。                                                                                                                                                                                                                                                                                                                                                                                                                           | |配置/存在/common/data/adjustData |控制XFA应用程序是否在合并后调整数据。                                                                                                                                                                                                                                                                                                                                                                                                                                        | | config/present/pdf/renderPolicy |控制是在服务器上完成页面内容的生成，还是将其延迟到客户端。                                                                                                                                                                                                                                                                                                                                                                                                            | |配置/存在/常用/区域设置 |指定输出文档中使用的默认区域设置。                                                                                                                                                                                                                                                                                                                                                                                                                                                   | |配置/存在/目标 |当包含在当前元素中时，指定输出格式。 当包含在openAction元素中时，指定在交互式客户端中打开文档时要执行的操作。                                                                                                                                                                                                                                                                                                              | |配置/存在/输出/类型 |指定要应用于文件的压缩类型或要生成的输出类型。                                                                                                                                                                                                                                                                                                                                                                                                               | |配置/存在/common/temp/uri |指定表单URI。                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | |配置/存在/常用/模板/基本 |为表单设计中的URI提供基本位置。 当此元素缺失或为空时，将使用表单设计的位置作为基础。                                                                                                                                                                                                                                                                                                                                                            | |配置/存在/常用/日志/收件人 |控制日志数据或输出数据写入到的位置。                                                                                                                                                                                                                                                                                                                                                                                                                                           | |配置/存在/输出/到 |控制日志数据或输出数据写入到的位置。                                                                                                                                                                                                                                                                                                                                                                                                                                           | | config/present/script/currentPage |指定打开文档时的初始页面。                                                                                                                                                                                                                                                                                                                                                                                                                                                     | |配置/存在/脚本/排除 |通知AEM Forms服务器/通信API要忽略哪些事件。                                                                                                                                                                                                                                                                                                                                                                                                                                     | |配置/存在/pdf/线性化 |控制输出PDF文档是否被线性化。                                                                                                                                                                                                                                                                                                                                                                                                                                                     | | config/present/script/runScripts |控制AEM Forms执行的脚本集。                                                                                                                                                                                                                                                                                                                                                                                                                                                           | |配置/存在/pdf/标记 |控制在输出PDF文档中包含标记。 PDF中的标记是文档中包含的用于显示文档逻辑结构的附加信息。 标记有助于辅助辅助功能和重新设置格式。 例如，页码可以标记为项目，以便屏幕阅读器不会在文本的中间发音它。 尽管标记使文档更有用，但标记也会增加文档的大小和创建文档的处理时间。 | |配置/存在/pdf/版本 |指定要生成的PDF文档的版本。                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
