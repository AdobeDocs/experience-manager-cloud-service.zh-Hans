...
**基本模板：**&#x200B;在Forms Designer或Acrobat表单(AcroForm)中创建的XFA模板（XDP文件）。 [基本模板](#base-template-of-a-document-of-record)用于为提交PDF指定样式和品牌信息。 请在之前将XFA模板（XDP文件）上传到您的AEM Forms实例
