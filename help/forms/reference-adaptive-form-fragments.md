...
自适应表单片段是一组字段，或是一个包含一组字段的面板，您可以在创建表单时使用这些字段。 它使您能够轻松、快速地创建表单。 您可以使用侧栏中的资产浏览器将自适应表单片段拖放到表单中，并在表单编辑器中对其进行编辑。

对于自适应Forms作者，在 [!DNL AEM Forms] 软件包 [[!DNL AEM FORMS] 引用片段](https://www.adobeaemcloud.com/content/marketplace/marketplaceProxy.html?packagePath=/content/companies/public/adobe/packages/cq630/fd/AEM-FORMS-6.3-REFERENCE-FRAGMENTS). 它包括以下片段：
