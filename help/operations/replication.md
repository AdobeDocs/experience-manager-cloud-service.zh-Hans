...
若要实现此功能的自动复制，请在&#x200B;**OSGi配置** [开启关闭触发器配置](/help/implementing/deploying/configuring-osgi.md)中启用&#x200B;**自动复制**：
...
| 名称 | 描述 |
| ------------- | ------------------------------------------- |
| onlyModified | 节点：自上次发布以来修改过的新节点和预先存在的节点 |
| onlyActivated | 节点：在上次发布之前已发布的节点 |
...
1. 从AEM [全局导航](/help/sites-cloud/authoring/basic-handling.md#global-navigation)，导航到&#x200B;**工具** > **部署** > **分发**
1. 选择&#x200B;**发布**&#x200B;卡
