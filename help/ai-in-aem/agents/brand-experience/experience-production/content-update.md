...
内容更新作业将您通过自然语言或可视化图表提供的详细信息转换为页面上的内容更新。 您可以提供需要更新的页面的URL，以及需要更新的内容的详细信息，座席技能将完成您的任务。 与AEM as a Cloud Service一起使用时，作业将创建新的[启动项](/help/sites-cloud/authoring/launches/overview.md)，这样您就可以在应用之前查看更新。 当与文档创作一起使用时，作业将创建新的[版本](https://experienceleague.adobe.com/en/docs/experience-manager-learn/sites/document-authoring/how-to/document-versions#)。
