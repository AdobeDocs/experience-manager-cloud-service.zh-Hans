...
了解开始使用Experience Modernization Agent和Experience Modernization Console的第一步。

>[!NOTE]
>
>如果您有兴趣使用Experience Modernization Console，可以通过您的客户经理请求获取访问权限，以确保获得顺利的新用户引导体验。

## 准备Edge Delivery GitHub存储库 {#prepare-repo}

>[!NOTE]
>
>使用AEM Sites和通用编辑器项目？ 执行[AEM Sites/Universal Editor快速入门](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md)设置步骤。
...
1. 确保存储库中安装了[AEM代码连接器](https://github.com/apps/aem-code-connector)。
   * 这将允许控制台检查您的代码。
...
1. 单击&#x200B;**连接存储库**。
1. 这将在新的浏览器选项卡上打开AEM代码连接器应用程序。 单击&#x200B;**授权AEM代码连接器**。
1. 返回控制台，指定站点的预览URL。 预览URL可以通过预览站点中的任何文档或者从分支、站点名称和组织构造它来获取。 系统将自动检索关联的Github项目，在某些情况下，系统可能会要求您提供Github坐标。
   ![正在连接到GitHub项目](assets/connect-site-and-github.png)
...
>[!TIP]
>
>[查看提示指南](/help/ai-in-aem/agents/brand-experience/modernization/prompting-guide.md)，了解有关如何提示代理及其技能的更多想法。

## 上传内容 {#upload-content}

>[!TIP]
>
>如果您正在处理AEM Sites和通用编辑器项目，将内容上传到AEM的工作方式略有不同。 有关具体上传说明，请参阅[AEM Sites/通用编辑器项目的Experience现代化代理快速入门](/help/ai-in-aem/agents/brand-experience/modernization/getting-started-aem-authoring.md#upload-content)。
...
* [体验现代化控制台](/help/ai-in-aem/agents/brand-experience/modernization/console.md) — 有关该控制台、其视图、选项和功能的详细信息
* [体验现代化代理的提示指南](/help/ai-in-aem/agents/brand-experience/modernization/prompting-guide.md) — 有关如何提示代理及其技能的想法
