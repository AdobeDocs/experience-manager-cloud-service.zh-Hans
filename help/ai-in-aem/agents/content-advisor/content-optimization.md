...
通过[内容发现代理搜索正确的资产，从而使用内容优化代理。](/help/ai-in-aem/agents/content-advisor/discovery.md)一旦相关图像浮出水面，用户就可以直接从搜索结果为一个或多个资源生成优化或特定于渠道的变体。 这一工作流程确保高质量的投入和持续更好的优化结果。 [有关详细信息，请参阅可用优化的完整列表](https://developer.adobe.com/experience-cloud/experience-manager-apis/api/stable/assets/delivery/)。
