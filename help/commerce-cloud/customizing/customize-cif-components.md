...
1. 在IDE中，在 **核心** 模块： `core/src/main/java/com/venia/core/models/commerce/MyProductTeaser.java`.
   ...
   `MyProductTeaser.java` 是一个可扩展CIF的Java界面 [ProductTeaser](https://github.com/adobe/aem-core-cif-components/blob/master/bundles/core/src/main/java/com/adobe/cq/commerce/core/components/models/productteaser/ProductTeaser.java) 界面。
...
1. 修改 `productteaser.html` 打电话 `isEcoFriendly` 方法：
   ...
   有关 `data-sly-test` 其他 [可以在此处找到HTL块语句](https://experienceleague.adobe.com/docs/experience-manager-htl/using/htl/block-statements.html#test).
