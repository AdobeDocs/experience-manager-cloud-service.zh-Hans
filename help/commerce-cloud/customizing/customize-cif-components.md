...
完成本教程需要一个本地开发环境。 这包括已配置并连接到Magento实例的AEM运行实例。 查看[将AEM作为Cloud Service SDK](../develop.md)设置本地开发的要求和步骤。 要完全学习本教程，您需要权限才能在Magento中向Product](https://docs.magento.com/user-guide/catalog/product-attributes-add.html)添加[属性。
