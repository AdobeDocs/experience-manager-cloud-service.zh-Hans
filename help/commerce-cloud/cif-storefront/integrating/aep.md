...
若要让有效的&#x200B;__AEM Commerce as a Cloud Service__&#x200B;本地环境具有必要的代码和配置，请完成以下步骤。
...
上述步骤将完成AEM Commerce和Experience Platform的设置。 您现在可以在产品UI中使用Google Chrome扩展`addToCart`雪铲检查器&#x200B;_和数据集_&#x200B;量度和图形&#x200B;__切换触发__&#x200B;事件并验证数据收集。
