...
1. 根据[Adobe Commerce网站、商店和视图中描述的模式配置多个商店和商店视图。](https://experienceleague.adobe.com/docs/commerce-admin/start/setup/websites-stores-views.html)
...
* [重用内容：多网站管理器和 Live Copy ](/help/sites-cloud/administering/msm/overview.md)
