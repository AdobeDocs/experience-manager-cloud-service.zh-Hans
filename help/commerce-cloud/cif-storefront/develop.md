...
基于适用于AEM Commerce的Commerce integration framework (CIF)开发AEM as a Cloud Service项目时，遵循与AEM as a Cloud Service上的其他AEM项目相同的规则和最佳实践。 请先查看以下内容：
...
>[!VIDEO](https://video.tv.adobe.com/v/347034/?captions=chi_hans&quality=12&learn=on)
