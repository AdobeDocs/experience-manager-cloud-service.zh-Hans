...
在AEM内容和Commerce创作历程的上一个文档[AEM CIF创作基础知识快速入门](/help/commerce-cloud/cif-storefront/commerce-journeys/aem-commerce-content-author/getting-started.md)中，您已了解CIF创作的基础知识。
...
可以使用任何类别/产品预览模板。 打开&#x200B;**页面信息**，然后选择&#x200B;**查看类别/产品**。 从选取器中选择产品/类别，以预览此产品/类别。 选择&#x200B;**购买Look**&#x200B;类别以获取更新模板的预览。
...
在此知识的基础上继续您的历程，接下来查看文档[管理分阶段产品目录体验](/help/commerce-cloud/cif-storefront/commerce-journeys/aem-commerce-content-author/staged-catalog.md)，了解如何使用分阶段产品数据和AEM启动项。

## 其他资源 {#additional-resources}

我们建议您查看文档[管理暂存产品目录体验，](/help/commerce-cloud/cif-storefront/commerce-journeys/aem-commerce-content-author/staged-catalog.md)来继续此历程的下一部分，以下是一些其他可选资源，这些资源对本文档中提到的一些概念进行了更深入的探究，但并非继续无头历程所必需的：

* [创建多个类别和产品页面](/help/commerce-cloud/cif-storefront/authoring/multi-template-usage.md)
* Experience Manager Cloud Service [迁移指南](/help/commerce-cloud/cif-storefront/migration.md) — 如何从旧版本迁移到AEM Commerce integration framework (CIF)加载项
