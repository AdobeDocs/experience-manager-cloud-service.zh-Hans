...
* [通用编辑器](#universal-editor) - 用于在 AEM 中创作内容的现代 UI

## 基于文档的创作  {#document-based}

在基于文档的创作中，您可以使用各种源，如Microsoft Word和Google文档。 来自这些源的文档将成为您网站上的页面。标题、列表、图像、字体元素、视频都可以从初始源转移到网站中。您可以出于 SEO 目的添加元数据，也可以使用块来处理结构化内容并添加功能。
