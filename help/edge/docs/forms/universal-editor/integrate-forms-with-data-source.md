...
2. 在 Experience Manager 登录页面上输入您的凭据。登录后，在左上角选择&#x200B;**[!UICONTROL Adobe Experience Manager]** > **[!UICONTROL 表单]** > **[!UICONTROL 表单和文档]**。
3. 选择&#x200B;**[!UICONTROL 创建]** > **[!UICONTROL 自适应表单]**。向导随即打开。在&#x200B;**源**&#x200B;选项卡中，选择一个模板：
...
1. 从&#x200B;**[!UICONTROL 数据源]**&#x200B;选项卡中选择数据元素，然后单击&#x200B;**[!UICONTROL 添加]**。
   ...
   您必须在表单元素中手动添加数据绑定，方法是在该表单元素的&#x200B;**绑定引用**属性中指定绑定。
例如，将数据绑定引用添加到表单中已有的**宠物名称**&#x200B;文本框中：
