...
1. 在 **[我的项目群](/help/implementing/cloud-manager/navigation.md#my-programs)** 在控制台中，点按或单击要为其添加环境的程序。

1. 在 **[我的项目群](/help/implementing/cloud-manager/navigation.md#my-programs)** 控制台，单击 **添加环境** 在 **环境** 信息卡以添加环境。
