...
1. 在&#x200B;**[我的程序](/help/implementing/cloud-manager/navigation.md#my-programs)**&#x200B;控制台上，点按或单击要为其添加环境的程序。
...
在任何情况下，[流量始终路由到另一个在线的最近区域。](/help/operations/additional-publish-regions.md)如果您仍然遇到问题，请联系Adobe客户关怀部门。
