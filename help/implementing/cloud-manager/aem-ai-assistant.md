...
## 如何在AEM中访问AI助手{#get-access}

1. [客户必须使用Adobe签署Gen AI附加程序](https://fieldreadiness-adobe.highspot.com/items/665f831c9f831b011aeda057#1)。

   GenAI Rider是客户与Adobe之间的法律协议，需要使用大多数AI和代理功能。 请联系Adobe客户关怀团队以了解更多信息。

1. AEM管理员可配置AI助手，以供在其组织中使用。 请参阅[在AEM中配置AI助手](/help/implementing/cloud-manager/aem-ai-assistant-admin.md)。
...
1. 在AEM中的AI助手上，单击![更多图标](https://spectrum.adobe.com/static/icons/workflow_18/Smock_More_18_N.svg)。
...
1. 选择一个类别以查看相关提示的列表。
1. 选择一个提示以更好地了解AEM中的AI助手可以回答的问题类型。

### 提供有关AEM中的AI助手的反馈

您的输入有助于改进AEM中的AI助手，以提高性能和准确性。
...
| ![标记图标](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Flag_18_N.svg) | 单击可报告关注事项或提供关于您与AEM中的AI助手交互的详细反馈。 |
