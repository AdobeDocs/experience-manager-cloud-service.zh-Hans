...
有关在AEM as a Cloud Service中设置用户和组的引导式演练，请参阅[配置对AEM as a Cloud Service的访问权限](https://experienceleague.adobe.com/en/docs/experience-manager-learn/cloud-service/accessing/overview)。
