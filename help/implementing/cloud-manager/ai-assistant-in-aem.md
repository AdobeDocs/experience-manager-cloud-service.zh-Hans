...
>[!NOTE]
> 
>客户组织必须接受其他法律条款才能启用AI助手。 有关详细信息，请联系您的Adobe客户代表。
...
1. 在底部附近的&#x200B;**AI助手**&#x200B;面板文本框中，键入您的问题，然后按`Enter`或单击![发送图标](https://spectrum.adobe.com/static/icons/workflow_18/Smock_Send_18_N.svg)。
