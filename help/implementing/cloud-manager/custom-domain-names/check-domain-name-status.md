...
* **删除失败** – 删除自定义域名失败，必须重试。
   ...
   * 参见 [管理自定义域名](/help/implementing/cloud-manager/custom-domain-names/managing-custom-domain-names.md) 了解更多信息。
...
即使您检查了记录已正确更新，此错误也可能在TXT记录的域验证期间发生。
...
参见 [添加自定义域名](/help/implementing/cloud-manager/custom-domain-names/add-custom-domain-name.md) 了解更多详细信息。
