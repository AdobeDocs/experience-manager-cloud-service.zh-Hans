...
AEM as a Cloud Service中的Cloud Manager 2023.12.0版的发布日期是2023年12月14日。 下一个版本计划于 2024 年 1 月 18 日发布。
...
* 通过 [Cloud Manager 自定义权限](/help/implementing/cloud-manager/custom-permissions.md)，可创建具有可配置的权限的自定义权限配置文件，以限制 Cloud Manager 用户访问项目、管道和环境。
   * 此功能计划分阶段推出，预计2024年2月Cloud Manager版本中完成。
...
* 对于新创建的Cloud Manager程序，默认情况下不激活[关联的New Relic子帐户](/help/implementing/cloud-manager/user-access-new-relic.md)。
   * 对于超过90天未访问New Relic子帐户的现有程序，将取消激活该帐户。
   * 如果要使用New Relic子帐户，必须通过Cloud Manager注册。
