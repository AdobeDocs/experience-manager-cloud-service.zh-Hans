...
* **自动设置新的 Forms 附加组件**
   ...
   * 在生产计划创建或生产计划编辑过程中出现在&#x200B;**解决方案与附加组件**&#x200B;列表中，前提条件是 IMS 组织必须持有可用的 Forms 附加组件许可证。
     ...
     ![编辑生产程序时的 Forms 附加组件](/help/implementing/cloud-manager/release-notes/assets/forms-add-on-editing-production-program.png) *在&#x200B;**编辑程序**&#x200B;中选择 Sites 程序的 Forms 附加组件，然后运行管道，在环境中将其激活。*
...
* **过滤器**&#x200B;面板添加了&#x200B;**投放类型**&#x200B;区段，其中包括&#x200B;**边缘投放**&#x200B;和&#x200B;**发布投放**&#x200B;两个复选框。<!-- (CMGR-69682) -->
