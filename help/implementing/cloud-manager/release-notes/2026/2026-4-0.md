...
description: 了解Adobe Experience Manager as a Cloud Service中的Cloud Manager 2026.4.0版本。
...
# Adobe Experience Manager as a Cloud Service中的Cloud Manager 2026.4.0发行说明 {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

了解AEM (Adobe Experience Manager) as a Cloud Service中的Cloud Manager 2026.4.0版本。
