...
description: 了解Adobe Experience Manager as a Cloud Service中的Cloud Manager 2026.3.0版本。
...
# Adobe Experience Manager as a Cloud Service中的Cloud Manager 2026.3.0发行说明 {#release-notes}

<!-- https://wiki.corp.adobe.com/display/DMSArchitecture/%5BKT%5D+Cloud+Manager+2025.08.0+Release -->

了解AEM (Adobe Experience Manager) as a Cloud Service中的Cloud Manager 2026.3.0版本。
...
![编辑非生产管道对话框，其中显示了“完全生成”和“智能生成”这两个生成策略选项](/help/implementing/cloud-manager/release-notes/assets/non-production-pipeline-edit.png)
