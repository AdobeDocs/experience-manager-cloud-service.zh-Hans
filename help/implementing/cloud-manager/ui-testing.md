...
在Cloud Manager管道中激活UI测试之前，建议在本地针对 [AEMas a Cloud ServiceSDK](/help/implementing/developing/introduction/aem-as-a-cloud-service-sdk.md)
或针对实际AEMas a Cloud Service实例。
