...
1. 开发您的测试案例，并[在本地运行这些测试](#run-ui-tests-locally)。
...
>
>请参阅 [AEM 测试示例存储库](https://github.com/adobe/aem-test-samples/blob/aem-cloud/ui-selenium-webdriver/README.md)以了解详细信息。
