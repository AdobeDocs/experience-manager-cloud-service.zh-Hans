...
沙盒程序中的环境在八小时不活动后自动休眠。沙盒环境在连续6个月休眠后会被删除。

请参阅 [休眠和解除休眠沙盒环境](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/hibernating-environments.md) 有关如何解除休眠环境和自动删除沙盒的更多详细信息。
