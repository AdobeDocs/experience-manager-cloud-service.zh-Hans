...
>[!IMPORTANT]
>
>确保您已安装[Node和NPM](https://nodejs.org/en/download/)的20版本，以便Adobe I/O CLI和相关插件正常工作。


1. 按照此[过程](https://developer.adobe.com/runtime/docs/guides/tools/cli_install/)安装Adobe I/O CLI工具。
1. 安装Adobe I/O CLI工具AEM RDE插件：
