...
在[编辑页面](/help/sites-cloud/authoring/fundamentals/editing-content.md)时，链接不处于活动状态。

* [切换到 **** ](/help/sites-cloud/authoring/fundamentals/editing-content.md#preview-mode) 预览模式，以使用内容中的链接进行导航。
