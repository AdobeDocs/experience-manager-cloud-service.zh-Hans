...
1. AEM as a Cloud Service环境的现代化。 有关详细信息，请参阅[AEM as a Cloud Service环境的现代化](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-learn/cloud-service/aem-apis/openapis/setup?#modernization-of-aem-as-a-cloud-service-environment)教程步骤。
