...
# 扩展 [!DNL Adobe Experience Manager] 使用Adobe Developer App Builderas a Cloud Service {#extend-using-app-builder}
...
App Builder自2020年夏季起通过Adobe开发人员预览版面向企业客户和合作伙伴提供。 App Builder的正式发布版(GA)计划于2021年12月发布。 Adobe欢迎开发人员通过来尝试App Builder [试用计划](https://developer.adobe.com/app-builder/trial/).
...
* Adobe Developer Console — 用于自定义微服务和扩展开发，让开发人员能够构建和管理项目，同时访问所需的所有工具和API，以便他们能够创建插件和集成。
