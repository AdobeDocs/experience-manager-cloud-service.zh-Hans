...
[Adobe Experience Manager Gems](https://helpx.adobe.com/experience-manager/kt/eseminars/gems/aem-index.html)是Adobe专家提供的一系列深入技术探讨。 此系列由Adobe工程师托管，可以很好地指导您更深入地了解AEM的功能。

{{ue-over-spa}}

AEM SPA Editor SDK在一系列AEM Gems课程中脱颖而出。 由于SPA编辑器已被弃用，这些组件已被删除。
