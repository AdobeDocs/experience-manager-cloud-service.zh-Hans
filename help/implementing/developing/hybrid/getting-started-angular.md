...
# AEM中的SPA使用Angular{#getting-started-with-spas-in-aem-using-angular}快速入门
...
`MainComponent`将摄取页面模型的JSON表示形式，并处理内容以包装/装饰页面的每个元素。 有关`Page`的更多详细信息，请参阅文档[SPA Blueprint](blueprint.md)。
