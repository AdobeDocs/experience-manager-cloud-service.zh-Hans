...
* 在AEM中启用了可编辑的正常外部React应用程序[。](editing-external-spa.md)
...
1. 将创建的`wknd-spa/components/imagecard`组件添加到页面模板中容器组件[的允许组件。](/help/sites-cloud/authoring/features/templates.md)
