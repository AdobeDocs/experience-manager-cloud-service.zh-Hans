...
* 在AEM中启用了工作的外部React应用程序[以进行编辑。](editing-external-spa.md)
* React应用程序使用RemotePage组件加载到AEM编辑器[中。](remote-page.md)
...
1. 将创建的`wknd-spa/components/imagecard`组件添加到页面模板中容器组件[的允许组件中。](/help/sites-cloud/authoring/features/templates.md)
