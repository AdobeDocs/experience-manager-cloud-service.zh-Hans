...
在媒体模式下，内容作者可以单击选择媒体内容。

![媒体模式](assets/media-mode.png)

内容的详细信息将显示在组件边栏中，作者还可以 [编辑媒体内容。](#editing-media)
...
在组件模式下，内容作者可以单击选择 [内容片段。](/help/assets/content-fragments/content-fragments.md)
...
时间 [组件模式，](#component-mode) 如果您选择 [内容片段，](/help/assets/content-fragments/content-fragments.md) 模式边栏上将显示编辑选项。
...
根据您选择的组件类型，可以在属性边栏中显示和修改详细信息。

![组件详细信息](assets/component-details.png)

请注意，并非所有组件都具有可以显示和/或编辑的详细信息。
...
如果您在 [文本模式](#text-mode) 并选择一个纯文本组件，则可以在原位置编辑文本。
...
>[!TIP]
>
>使用热键 `R` 以打开资产选择器来替换选定的图像。

### 编辑内容片段 {#edit-content-fragment}

如果您在 [组件模式](#component-mode) 然后您选择 [内容片段，](/help/assets/content-fragments/content-fragments.md) 您可以在组件边栏中编辑其详细信息。

![编辑内容片段](assets/ue-edit-cf.png)

在选定内容片段的内容模型中定义的字段在组件边栏中显示和编辑。

更改会自动保存到您的内容。

如果您想在 [内容片段编辑器](/help/assets/content-fragments/content-fragments-managing.md#opening-the-fragment-editor) 相反，请单击 [编辑按钮](#edit) 在模式边栏中。
