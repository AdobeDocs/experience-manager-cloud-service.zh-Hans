...
它还包含一个`content`对象，该对象具有用于每个插件[要存储的内容的特定于端点的详细信息的其他对象。](/help/implementing/universal-editor/architecture.md)例如，如果您的应用程序基于AEM和Magento中的内容，则有效负载将包含每个系统的数据对象。
