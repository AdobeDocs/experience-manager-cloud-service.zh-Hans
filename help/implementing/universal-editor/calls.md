...
成功完成调用后，请求和响应的负载中包含的事件就会被触发，您可以为自己的应用程序自定义这些事件。请参阅文档[通用编辑器事件](/help/implementing/universal-editor/events-universal-editor.md)，了解更多详细信息。
...
* [通用编辑器事件](/help/implementing/universal-editor/events-universal-editor.md)
