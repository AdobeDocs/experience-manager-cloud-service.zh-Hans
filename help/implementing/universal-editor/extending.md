...
有关通用编辑器UI中可用的扩展点的完整列表，请参阅Adobe Developer文档[通用编辑器扩展点。](https://developer.adobe.com/uix/docs/services/aem-universal-editor/api/)

## 其他资源 {#additional-resources}

除了UI可扩展性之外，通用编辑器还提供了其他自定义选项，以实现自定义业务要求的无缝集成。
