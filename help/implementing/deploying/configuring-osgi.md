...
>[!TIP]
>
>您可以使用Cloud Manager配置环境变量。 有关更多信息，请参阅文档。 [此处。](/help/implementing/cloud-manager/environment-variables.md)
...
>[!TIP]
>
>您还可以使用Cloud Manager配置环境变量。 有关更多信息，请参阅文档。 [此处。](/help/implementing/cloud-manager/environment-variables.md)
