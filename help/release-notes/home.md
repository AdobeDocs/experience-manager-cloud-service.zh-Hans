...
除了创新速度之外，[!DNL Adobe Experience Manager] as a Cloud Service 还提供了灵活性，可在即将推出的功能发布到生产环境前的一整个月预览这些功能。这可让您在自己的自定义环境中试用功能并提前培训/帮助内部用户做好准备，从而评估即将发布的版本对组织的影响。如果您有 AEM 加载项（例如 Forms），也可以通过在[程序设置](/help/implementing/cloud-manager/getting-access-to-aem-in-cloud/creating-production-programs.md)中选择解决方案来确保对其进行更新。
...
1. 对您的用户进行培训：使用文档和 Experience League 资产，让用户快速了解并熟悉新功能。
