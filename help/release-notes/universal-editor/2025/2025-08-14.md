---
title: 通用编辑器2025.08.14发行说明
description: 这些是通用编辑器2025.08.14版的发行说明。
...
# 通用编辑器2025.08.14发行说明 {#release-notes}
...
* [RTE早期采用者的新功能](#new-rte)
   * 添加了一个配置选项，用于在RTE链接对话框中禁用Target。
...
* 修复了[新RTE](#new-rte)中全屏滚动的问题。
* 编辑条件字段时的持久行为已更正。
* `aem-content-fragment`已允许在变体之间切换。
