...
- SITES-13253 — 修复了核心组件v2.22.6中RecursionTooDeepException的问题
- SITES-13256 — 修复了配置了特殊URL的核心WCM Teaser中断页面渲染的问题
- GRANITE-45462 — 修复了消息传送客户端多区域配置的问题
- GRANITE-45562 — 修复了图像组合返回200而不是404的问题
