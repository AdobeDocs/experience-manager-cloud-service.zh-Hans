...
2024.10.0 功能激活提供此维护版本的全套功能。有关更多信息，请参阅[&#x200B; Experience Manager 发布路线图](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-release-information/aem-release-updates/update-releases-roadmap)。
...
* GUIDES-17793：在批量激活已发布内容的过程中，没有从&#x200B;**批量发布功能板**&#x200B;激活引用的PDF。
...
* 站点 — 16357：AEM：在设置Analytics选项卡中，从站点菜单截断按钮。
* SITES - 19836：容器中的幽灵组件显示在发布和预览实例上。
* SITES - 22348：如果项目的 Live Copy 超过 100 个，则 Live Copy 概述页面无法加载。
