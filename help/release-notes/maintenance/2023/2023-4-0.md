...
- GRANITE-44542 — 已报告未为包筛选器中包含的文件夹指定包节点类型（通过提供带有jcr:primaryType的.content.xml）的客户遇到的问题。 这会导致这些文件夹被视为nt:folder，从而会在各种情况下造成问题。
