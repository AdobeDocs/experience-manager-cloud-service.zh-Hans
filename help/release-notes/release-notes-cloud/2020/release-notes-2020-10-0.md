...
description: '[!DNL Adobe Experience Manager]个2020.10.0版as a Cloud Service发行说明。'
...
* **[!DNL Adobe Asset Link]版本2.1**： [!DNL Adobe Photoshop]、[!DNL Adobe Illustrator]和[!DNL Adobe InDesign]的[AdobeAsset Link](https://helpx.adobe.com/cn/enterprise/using/manage-assets-using-adobe-asset-link.html)扩展的新版本可用。 它增加了与2020年10月发布的版本2021的最新[!DNL Adobe Creative Cloud]应用程序的兼容性。
