...
[!DNL Adobe Experience Manager] as a [!DNL Cloud Service] 最新功能版本 (2023.2.0) 的发布日期为 2023 年 4 月 12 日。下一个功能版本 (2023.4.0) 计划于 2023 年 5 月 31 日发布。
...
* 增加了对 WebP 图像的支持，可自动提取元数据、生成缩略图和自定义演绎版。這些檔案現在也支援智慧標籤功能。
