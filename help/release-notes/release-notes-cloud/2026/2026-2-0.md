---
title: ' [!DNL Adobe Experience Manager] as a Cloud Service 2026.2.0版的发行说明。'
description: ' [!DNL Adobe Experience Manager] as a Cloud Service 2026.2.0版的发行说明。'
...
# [!DNL Adobe Experience Manager] as a Cloud Service的2026.2.0发行说明 {#release-notes}

以下部分概述了[!DNL Experience Manager] as a Cloud Service 2026.2.0版本的功能发行说明。
...
请查看2026年2月发布概述视频，了解2026.2.0版本中新增功能摘要：
