...
# [!DNL Adobe Experience Manager] as a Cloud Service 2023.9.0 版的发行说明 {#release-notes}

以下部分概述了 2023.9.0 版的 [!DNL Experience Manager] as a Cloud Service 的功能发行说明。
...
观看 2023 年 9 月版概述视频可了解在 2023.9.0 版中添加的功能的概要：
