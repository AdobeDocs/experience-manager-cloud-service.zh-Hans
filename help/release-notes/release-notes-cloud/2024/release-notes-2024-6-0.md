---
title: ' [!DNL Adobe Experience Manager] as a Cloud Service 2024.6.0 版的发行说明。'
description: ' [!DNL Adobe Experience Manager] as a Cloud Service 2024.6.0 版的发行说明。'
...
# [!DNL Adobe Experience Manager] as a Cloud Service 2024.6.0 版的发行说明 {#release-notes}

以下部分概述了 2024.6.0 版的 [!DNL Experience Manager] as a Cloud Service 的功能发行说明。
