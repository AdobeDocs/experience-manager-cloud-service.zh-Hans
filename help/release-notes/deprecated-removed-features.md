...
>[!IMPORTANT]
>
>多个[已弃用的API](#aem-apis)将于2026年6月11日&#x200B;**删除**。 请查看以下关键日期和影响：
>
>* **从2026年1月26日开始**：如果最近执行了管道，将发送操作中心通知电子邮件以提醒删除这些API的使用。
>* **2026年2月26日**：包含使用这些API的代码的Cloud Manager管道将在&#x200B;**代码质量**&#x200B;步骤期间&#x200B;**暂停**。 部署管理员、项目管理员或业务负责人可以覆盖此问题以允许管道继续。 *这可能会降低验证和发布代码更改的能力。*
>* **2026年4月14日**：包含使用这些API的代码的Cloud Manager管道将在&#x200B;**代码质量**&#x200B;步骤期间&#x200B;**失败**。 在删除已弃用的API用法之前，将阻止部署。 *这可能会阻止您发布时效性更新，并可能影响您的业务运营。*
>* **2026年6月11日**：仍在使用已弃用API的环境&#x200B;**将不会收到关键的Adobe版本更新**，并且不会受Adobe有关性能和可用性的标准承诺的约束。 因此，您将不会收到新功能或错误修复，应用程序的稳定性和正常运行时间可能会受到负面影响，并且安全风险敞口可能会进一步增加。 要再次接收Adobe版本更新，必须成功执行全栈管道；然后，将在几天内应用更新。
>
...
| Sites | [SPA 编辑器](/help/implementing/developing/hybrid/introduction.md) | 在 AEM 中管理无头内容的首选编辑器有：<br>- [通用编辑器](https://www.aem.live/docs/aem-authoring)，用于进行可视化编辑。<br>- [内容片段编辑器](/help/assets/content-fragments/content-fragments-managing.md)，用于进行基于表单的编辑。 |
...
>* **2026年2月26日**：包含使用这些API的代码的Cloud Manager管道将在&#x200B;**代码质量**&#x200B;步骤期间&#x200B;**暂停**。 部署管理员、项目管理员或业务负责人可以覆盖此问题以允许管道继续。 *这可能会降低验证和发布代码更改的能力。*
>* **2026年4月14日**：包含使用这些API的代码的Cloud Manager管道将在&#x200B;**代码质量**&#x200B;步骤期间&#x200B;**失败**。 在删除已弃用的API用法之前，将阻止部署。 *这可能会阻止您发布时效性更新，并可能影响您的业务运营。*
>* **2026年6月11日**：仍在使用已弃用API的环境&#x200B;**将不会收到关键的Adobe版本更新**，并且不受Adobe有关性能和可用性的标准承诺的约束。 因此，您将不会收到新功能或错误修复，应用程序的稳定性和正常运行时间可能会受到负面影响，并且安全风险敞口可能会进一步增加。
>
...
<td>org.apache.felix.webconsole<br>org.apache.felix.webconsole.bundleinfo<br>org.apache.felix.webconsole.i18n<br>org.apache.felix.webconsole.spi</td>
  ...
  <tr>
    ...
    <td>此API依赖于commons-lang（自2021年起已弃用）而被弃用。</td>
    <td>11/30/2025</td>
    <td>9/30/2026</td>
  </tr>
  <tr>
...
<td>org.apache.commons.lang<br>org.apache.commons.lang.enums<br>org.apache.commons.lang.builder<br>org.apache.commons.lang.exception<br>org.apache.commons.lang.math<br>org.apache.commons.lang.mutable<br>org.apache.commons.lang.reflect<br>org.apache.commons.lang.text<br>org.apache.commons.lang.time</td>
  ...
  <tr>
    ...
    <td>OSGi服务HTTP API已弃用，请改用OSGi Servlet Whiteboard。</td>
    <td>5/1/2024</td>
    <td>2027年12月31日（暂定）</td>
  </tr>
  </tbody>
...
如果尚未在5月4日之前进行更新，您将不再收到AEM版本更新。 要再次接收Adobe版本更新，必须成功执行全栈管道；然后，将在几天内应用更新。

### 一般准则

如果您使用当前需要已弃用API的第三方库，请尝试更新到该第三方库的更新版本。

如果您决定部署自己的已弃用API版本（例如您自己的Guava版本），请确保所有使用此API的捆绑包都将连接到您的版本。 如果您决定部署当前包含在Cloud Service中的相同主版本，则无需执行进一步操作。 但是，如果您按照建议操作并部署最新版本，则需要调整您的Maven项目，在`aem-sdk-api`之前包含该库作为新依赖项。 这样，您的代码将连接到新版本。 进行更改后，请使用[AEM as a Cloud Service SDK构建分析器Maven插件](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-core-components/using/developing/archetype/build-analyzer-maven-plugin)验证是否不再标记弃用的API的使用情况。

如果您使用的是ACS AEM Commons，请至少使用版本6.17.2（建议使用最新版本），并通过为内容包指定分类器`cloud`确保您[包含Cloud Service](https://adobe-consulting-services.github.io/acs-aem-commons/pages/maven.html)的版本。
...
* 如果您正在使用ACS AEM Commons更新到最新版本（至少6.17.2）并确保使用`cloud`分类器。
* 从`org.apache.sling.commons.auth`和/或`org.apache.sling.commons.auth.spi`迁移到`org.apache.sling.auth`响应。 `org.apache.sling.auth.spi`.
