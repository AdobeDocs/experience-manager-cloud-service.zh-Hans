...
1. 打开文件夹以查看翻译项目。
1. 单击/点按项目以打开详细信息页面。
1. 要查看翻译作业的状态，请单击 **[!UICONTROL 翻译作业]** 图块。 <!-- For more details around job statuses, see [Monitoring the Status of a Translation Job](/help/sites-administering/tc-manage.md#monitoring-the-status-of-a-translation-job). -->
...
1. 单击/点按底部的省略号 **翻译作业** 用于在翻译工作流中查看资产的拼贴。 翻译作业列表还会显示资产元数据和标记条目。这些条目指示资产的元数据和标记也会被翻译。
