...
使用预定义的编辑组件配置编辑器的操作在创建和配 [置资产编辑器页面中有介绍](https://helpx.adobe.com/experience-manager/6-5/assets/using/assets-finder-editor.html)。
...
您可以修改元数据表单中可用的命 [名空间](https://helpx.adobe.com/experience-manager/6-5/assets/using/assets-finder-editor.html)。
