...
有关使用预定义编辑组件配置编辑器的信息，请参 [阅创建和配置资产编辑器页面](https://helpx.adobe.com/experience-manager/6-5/assets/using/assets-finder-editor.html)。
...
您可以修改元数据表单中 [的命名空间](https://helpx.adobe.com/experience-manager/6-5/assets/using/assets-finder-editor.html)。
