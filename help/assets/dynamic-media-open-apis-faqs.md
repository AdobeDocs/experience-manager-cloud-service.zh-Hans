...
点击此处了解有关如何使用[实验性 API](https://developer.adobe.com/experience-cloud/experience-manager-apis/guides/how-to/#experimental-apis) 和[修饰符完整列表](https://developer.adobe.com/experience-cloud/experience-manager-apis/)的更多信息。
