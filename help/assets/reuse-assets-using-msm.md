...
中的多站点管理器(MSM)功能 [!DNL Adobe Experience Manager] 使用户能够重复使用一次创作并在多个Web位置重复使用的内容。 对数字资源可使用相同的功能，其名称为MSM [!DNL Assets]. 将MSM用于 [!DNL Assets]，您可以：
...
|---|---|---|
| [!UICONTROL 引用] 边栏 | 选择源后快速同步。 | 参见 [源的“引用”边栏中的快速操作](#ref-rail-source) |
