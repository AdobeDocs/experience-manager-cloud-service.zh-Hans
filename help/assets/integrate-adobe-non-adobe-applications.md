---
title: 使用内容审查程序访问Adobe和非Adobe应用程序中的AEM内容
description: Content Advisor跨Adobe和非Adobe应用程序提供统一的内容发现体验，并将智能、上下文感知型发现直接引入创作体验。
...
# 使用内容审查程序访问Adobe和非Adobe应用程序中的AEM内容{#content-advisor-aem-assets-adobe-non-Adobe-applications}

Content Advisor可以跨Adobe和非Adobe应用程序提供统一的内容发现体验。 Content Advisor与Adobe Workfront、AJO B2C（即将推出）、AEM Sites和非Adobe应用程序等应用程序原生集成，在单个智能界面中将内容（资源和内容片段）整合在一起。 它使您能够在工作流程中轻松地发现、浏览和重新使用最相关的内容，因此您可以在不中断上下文的情况下更快地移动。
...
| [AEM Sites — 文档创作](https://www.aem.live/docs/authoring-guide#document-authoring) | ✓ | ✓ | ✓ | − |
| [AEM Sites — 通用编辑器](https://www.aem.live/docs/authoring-guide#universal-editor-in-aem-sites) | ✓ | ✓ | ✓ | − |
| AEM Sites - [GoogleDrive](https://www.aem.live/docs/authoring-guide#google-drive)/[Sharepoint创作](https://www.aem.live/docs/authoring-guide#microsoft-sharepoint) | ✓ | − | ✓ | − |
| AEM Sites — 内容片段编辑器（仅在“内容引用”字段中） | ✓ | ✓ | ✓ | − |
| Adobe Workfront工作流程 | ✓ | ✓ | − | ✓ |
| Adobe Workfront规划 | ✓ | ✓ | − | ✓ |
| [AEM Assets视图](/help/assets/assets-view-introduction.md) | ✓ | − | − | − |
| [AEM Content Hub](/help/assets/product-overview.md) | ✓ | ✓ | − | − |

## 跨非Adobe应用程序支持内容审查程序功能 {#content-advisor-feature-support-non-adobe-applications}
...
这允许您直接在外部应用程序中发现、评估和使用AEM Assets中的已批准资源，同时与Adobe Express和其他Adobe应用程序中提供的体验保持一致。

有关集成、属性和自定义的更多信息，请参阅以下文章：

* [内容审查程序集成示例](https://github.com/adobe/aem-assets-selectors-mfe-examples/tree/consolidate-docs-to-experience-league/examples)

* [内容审查程序属性](/help/assets/content-advisor-properties.md)

* [内容审查程序自定义](/help/assets/content-advisor-customization.md)
