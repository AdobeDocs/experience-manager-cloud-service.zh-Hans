...
在后端运行异步下载时，用户可以继续探索并进一步在Experience Manager中工作。 除了Experience Manager收件箱通知之外，Experience Manager还可以发送电子邮件，以在下载过程完成后通知User。 若要启用此功能，管理员可以通过[配置SMTP服务器连接](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/implementing/developing/development-guidelines.html#sending-email)来配置电子邮件服务。
...
>* [使用支持的Adobe Creative Cloud应用程序中的AdobeAssets链接下载资源](https://helpx.adobe.com/enterprise/using/manage-assets-using-adobe-asset-link.html)
