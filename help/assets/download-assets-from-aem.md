...
可以通过将如下所示的OSGI配置添加到应用程序代码并[通过Cloud Manager管道进行部署](https://experienceleague.adobe.com/zh-hans/docs/experience-manager-cloud-service/content/implementing/deploying/configuring-osgi)来增加下载大小限制：
