...
1. 根据您单击的资产类型，执行下列任一操作：
   ...
   <table>
    <tbody>
      ...
      <li>要将图像返回到原始的缩放图像，请点按<strong>重置</strong>。</li>
      <li>要在显示设备上最大化查看器，请点按<strong>全屏</strong>。</li>
      </ul>
      ...
      <td><p><strong>要预览特定演绎版中的资产</strong></p>
        ...
        </ul><p>使用 <strong>+</strong> 和 <strong>-</strong> 图标可分别增大和减小选定图像的缩放比例。要将图像恢复为原始缩放，请点按<strong>重置</strong>。<br />如果您在触摸屏上，请多次点按图像以逐步放大。当您达到最大缩放比例时，再连按两次图像可重置缩放状态。横向拖动图像可进行平移。
</p> </td>
      </tr>
      <tr>
      <td>多媒体</td>
      ...
      <td><p><strong>要预览特定演绎版中的资产</strong></p>
        <ul>
        <li>在页面的左上角附近，单击图标以显示下拉列表。 单击列表中的<strong>演绎版</strong>，然后选择要预览的特定演绎版。</li>
        </ul><p>选择要预览的高分辨率视频演绎版可能会导致视频出现截断。 原因在于演绎版预览在用于预览的嵌入式查看器的上下文中向您显示了客户看到的确切分辨率。</p><p>当您在资产级别预览自适应视频集时，这些演绎版将分组为一个播放体验。 也就是说，自适应视频的大小可以正确地进行查看，并在查看设备和连接速度的上下文中使用最佳分辨率进行回放。<br /></p><p><strong>在特定查看器中预览资产</strong></p>
        <ul>
        <li>在页面的左上角附近，单击图标以显示下拉列表。 单击列表中的<strong>查看器</strong>，然后选择要应用到资产的查看器。</li>
        </ul> </td>
      </tr>
