...
>[!NOTE]
>
>当您位于Adobe Experience Manager的网页（站点）上时，无法在&#x200B;**[!UICONTROL 编辑]**&#x200B;模式下预览资产。 相反，单击页面右上角的&#x200B;**[!UICONTROL 预览]**，以转到预览模式。

要在用户界面中启用或禁用查看器预设，请参阅[管理查看器预设](/help/assets/dynamic-media/managing-viewer-presets.md)。

**要预览资产，请执行以下操作：**

1. 从&#x200B;**[!UICONTROL Experience Manager]**&#x200B;的&#x200B;**[!UICONTROL 导航]**&#x200B;页面上，点按&#x200B;**[!UICONTROL 资产]**，然后点按&#x200B;**[!UICONTROL 文件]**&#x200B;以访问资产。
...
1. 根据您单击的资产类型，执行以下任一操作：
   ...
   <table>
    <tbody>
      ...
      <li>要将图像返回到原始区域，请点按<strong>重置</strong>。</li>
