...
| AI生成的字幕 | 为由AI支持的视频创建字幕。 利用人工智能，它创建视频的文字记录并将其转换为字幕。 甚至时间线也被定义了。 |
...
1. 要创建支持案例，请按照说明操作，同时确保提供以下信息：
   ...
   * 指定您希望在AEM as a Cloud Service的Dynamic Media帐户中启用DASH、多字幕和多音频曲目以及AI生成的字幕支持。
