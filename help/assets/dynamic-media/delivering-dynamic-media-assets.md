...
>[!NOTE]
>
>智能成像可与您现有的图像预设配合使用。 它利用在最后毫秒的交付过程中提供的智能，根据浏览器或网络连接速度进一步减小图像文件大小。 参见 [智能成像](/help/assets/dynamic-media/imaging-faq.md) 了解更多信息。
...
* [为响应式网站投放优化图像](/help/assets/dynamic-media/responsive-site.md)
