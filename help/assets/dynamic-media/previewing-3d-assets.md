---
title: 预览3D资产
description: 了解如何在Dynamic Media预览3D资产。
...
# 在AEM{#previewing-3d-assets}中预览3D资产
...
1. 确保您已将 3D 资产上传到 AEM。请参阅[3D预览](#supported-3d-previewing-assets)和[上传资产](/help/assets/manage-digital-assets.md#uploading-assets)支持的格式。
