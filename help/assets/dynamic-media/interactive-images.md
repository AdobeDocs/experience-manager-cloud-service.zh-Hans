...
查看 [上图所示网页上的](https://marketing.adobe.com/resources/help/en_US/dm/shoppable-banner/we-fashion-QVzoom/index2-shoppable.html) “交互式图像”的实际操作情况。
...
1. **在AEM中向网站或网站添加交互式图像。如果您使用AEM** Sites或AEM eCommerce，或二者兼用，则可以通过将交互式媒体组件拖动到页面上，将交互式图像直接添加到AEM中的网页。 See [Adding Dynamic Media Assets to Pages.](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)
...
>* 您对AEM的实施不使 *用* eCommerce integration framework从任何电子商务解决方案（如IBM Websphere Commerce、Elastic Path、hybris或Intershop）将产品数据提取到AEM。
>
>
...
>
>另请参阅传 [送横幅](/help/assets/dynamic-media/carousel-banners.md)。
...
1. 执行下列操作之一：
   ...
   * 点按&#x200B;**[!UICONTROL 超链接]**。
   ...
   有关更 [多信息，请参阅使用选择器](/help/assets/dynamic-media/working-with-selectors.md) 。
...
以演 [示网站为例](https://marketing.adobe.com/resources/help/en_US/dm/shoppable-banner/we-fashion/landing-0.html)，注意这三个人的图片是一个静态标 `IMG` 签：
