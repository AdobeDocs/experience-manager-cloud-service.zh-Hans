...
通过Dynamic Media，您可以在发布资产之前管理资产。 中详细介绍了如何使用一般资产 [使用数字资产](/help/assets/manage-digital-assets.md). 一般主题包括上传、下载、编辑和发布资产；查看和编辑属性以及搜索资产。
...
启用Dynamic Media后，您可以通过单击 `+` 和 `-` 按钮。 您还可以单击/点按以放大特定区域。 还原会将您带到原始版本，您可以通过单击对角线箭头使图像变为全屏。 启用Dynamic Media的过程如下所示：
