...
经验丰富的网站开发人员和程序员是Dynamic Media常规设置的目标受众。 Adobe Dynamic Media建议更改发布设置的用户熟悉Adobe Experience Manager上的Dynamic Media以及基础图像技术。
...
对于新上传，PDF考虑进行提取的最大页数为5000。 2022年12月31日，此限制将更改为100页（对于所有PDF）。 另请参阅[Dynamic Media限制](/help/assets/dynamic-media/limitations.md)。
