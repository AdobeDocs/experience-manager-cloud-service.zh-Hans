...
请参 [阅配置Dynamic MediaCloud Services。](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services)
...
1. 从AEM的导航页 **[!UICONTROL 面]** ，点 **[!UICONTROL 按资产>文件]**。
