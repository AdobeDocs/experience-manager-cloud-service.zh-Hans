...
在Dynamic Media中处理3D资产之前，请确保AEM管理员已启用并配置Dynamic Media Cloud服务。

请参 [阅配置Dynamic Media Cloud服务。](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services)
...
1. 确保您已将 3D 资产上传到 AEM。
   ...
   请参 [阅上传要在Dynamic Media中使用的3D资产。](/help/assets/add-assets.md#upload-assets)
...
1. 当网页处于编辑模 **[!UICONTROL 式时]** ，请执行下列操作之一：
   ...
   * 从浏 `/editor.html` 览器中的页面URL中删除。
   ![
完全交互的3D资产，如 ](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)****

1. ![3D资产显示在3D媒体组件内部](/help/assets/dynamic-media/assets/3d-asset-in-3d-mediaa.png)在预览模式下显示的完全交互 **[!UICONTROL 式3D资]** 产。
...
* [Dynamic Media包含Dynamic Media 3D Media组件，可在AEM Sites中使用它在网页上启用3D模型的交互式查看。](#adding-three-d-media-component-to-page-template)
...
1. 点按 **[!UICONTROL 编辑]** ，打开模板。
   ...
   在页面右上角的下拉菜单中，选择“结构 **[!UICONTROL 模式]** ”（如果它尚未处于活动状态）。](/help/assets/dynamic-media/assets/3d-media-component-structurea.png)
...
1. 在“属 **[!UICONTROL 性]** ”部分的“允许的组 **[!UICONTROL 件]** ”选项卡下，滚动至 **[!UICONTROL Dynamic Media]**，然后展开列表并检 ****&#x200B;查3D媒体。
   ...
   点按 **[!UICONTROL 完成]** ，以保存更改并关闭策 **[!UICONTROL 略编辑器]**。

## 您现在可以将Dynamic Media 3D Media组件放置到使用此模板的所有页面上。{#adding-the-three-d-media-component-to-a-web-page}

将3D媒体组件添加到网页 {#adding-the-three-d-media-component-to-a-web-page}

如果您使用Adobe Experience Manager作为Web内容管理系统，则可以通过3D媒体组件将3D资产添加到网页。[](/help/assets/dynamic-media/adding-dynamic-media-assets-to-pages.md)
...
1. 打开AEM Sites，选择要向其添加Dynamic Media 3D Media组件的网页。********
   ...
   点按编 **[!UICONTROL 辑]** （铅笔）图标以在页面编辑器中打开页面。 确保 **[!UICONTROL 在页]** 面的右上角附近选择了“编辑”模式。](/help/assets/dynamic-media/assets/3d-media-component-edita.png)

1. ![3d-media-component-add](/help/assets/dynamic-media/assets/3d-media-component-edita.png)

1. 在工具栏中，点按侧面板图标以切换或“打开”面板的显示。****

   在侧面板中，点按加号图标以打开组 **[!UICONTROL 件]** 列表。](/help/assets/dynamic-media/assets/3d-assets-filtera.png)
...
1. 在AEM Sites页面编辑器中，选 **[!UICONTROL 择之前添加到页面的]** 3D Media Viewer组件。
   ...
   点按配 **[!UICONTROL 置图标]** （扳手）以打开组件配置对话框。](/help/assets/dynamic-media/assets/3d-media-component-configa.png)

1. ![3d-media-component-config](/help/assets/dynamic-media/assets/3d-media-component-configa.png)]**

   在“3D媒体”对话框的“查看器预设”下拉列表中，选 **[!UICONTROL 择]** “维”以将维查看器预设分配给组件。](/help/assets/dynamic-media/assets/3d-media-component-edit-configa.png)
...
1. 在侧面板中，搜索或滚动到要在所编辑页面上视图的3D资产。****
   ...
   将3D资产从“资产”侧面板拖放到您之前 **[!UICONTROL 添加到页面的]** 3D媒体组件上。](/help/assets/dynamic-media/assets/3d-asset-adda.png)
...
如果您正在将AEM用作WCM，请使用此发布方法直接将Dynamic Media 3D资产添加到网页。[](/help/assets/dynamic-media/publishing-dynamicmedia-assets.md)
...
1. **要发布静态Dynamic Media 3D资产，请执行以下操作：**
...
1. 点按 **[!UICONTROL 关闭]** ，以退出对话框并返回到资产详细信息页面。
   ...
   从3D资产文件名左侧的下拉列表中，点按演绎 **[!UICONTROL 版]**。](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)
...
1. ![3d-asset-renditions](/help/assets/dynamic-media/assets/3d-asset-renditionsa.png)]******
   ...
   * 3D资源已被引入Dynamic Media图像生产系统(IPS)。
   ![将发布3D资产。](/help/assets/dynamic-media/assets/3d-asset-urla.png)
...
* 如果您不使用AEM作为WCM，请使用以下两 *种方* 法发布Dynamic Media 3D资产。]******
   ...
   **[!UICONTROL URL]** —— 如 **[!UICONTROL 果您使用第]** 三方Web内容管理系统，并且希望使用维查看器将Dynamic Media 3D资产链接到您的网页，请使用URL。](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)
...
* See [Linking URLs to your web application.](/help/assets/dynamic-media/linking-urls-to-yourwebapplication.md#obtaining-a-url-for-an-asset)]**********
   ...
   **[!UICONTROL 嵌入]** -当 **[!UICONTROL 您希望使用]** “维”查看器视图嵌入到网页中的Dynamic Media 3D资产时，请使用“嵌入”。 将嵌入代码复制到剪贴板，以便将其粘贴到网页中。 Editing of the code is not permitted in the **[!UICONTROL Embed]** dialog box.](/help/assets/dynamic-media/embed-code.md#embedding-the-video-or-image-viewer-on-a-web-page)
