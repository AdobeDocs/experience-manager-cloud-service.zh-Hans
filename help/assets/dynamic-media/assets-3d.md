...
1. 当网页处于编辑模 **[!UICONTROL 式时]** ，请执行下列操作之一：
   ...
   * 从浏 `/editor.html` 览器中的页面URL中删除。
   ![3D资产显示在3D媒体组件内部](/help/assets/dynamic-media/assets/3d-asset-in-3d-media.png)在预览模式下显示的完全交互 **[!UICONTROL 式3D资]** 产。
...
1. 将3D资产从“资产”侧面板拖放到您之前 **[!UICONTROL 添加到页面的]** 3D媒体组件上。
   ...
   ![将3d资产分配给3d媒体组件](/help/assets/dynamic-media/assets/3d-asset-add.png)
