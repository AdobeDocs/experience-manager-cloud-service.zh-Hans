...
如果需要，您可以[编辑旋转集](#editing-spin-sets)。 此外，您还可以视图和修改[旋转集属性](/help/assets/manage-digital-assets.md#editing-properties)。

## 上传旋转集{#uploading-assets-for-spin-sets}的资产

对于一维旋转集，一个项目至少需要8-12张照片。拍照必须以固定的间隔拍摄，以给人以项目正在旋转和翻动的印象。 例如，如果一维旋转集中包含 12 幅拍照，则每拍照一次应将项目旋转 30 度 (360/12)。
