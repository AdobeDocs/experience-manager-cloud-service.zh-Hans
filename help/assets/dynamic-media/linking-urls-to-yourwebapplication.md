...
另请参阅[将YouTube URL关联到您的Web 应用程序](video.md)。
...
1. 根据您选择的资产，执行以下操作之一：
   ...
   * 如果您选择了图像，请在下拉菜单中点按&#x200B;**[!UICONTROL 演绎版]**。
      ...
      在&#x200B;**[!UICONTROL Dynamic]**&#x200B;标题下，点按预设名称以视图右侧帧中的演绎版。 如有必要，滚动演绎版列表以查看动态标题。
...
1. 要预览资产或添加到您的Web内容页面，请选择文本并将其复制到您的Web浏览器。
...
1. 根据您使用的视频投放协议，复制相应的协议选择器。 在这些步骤的后面，您需要复制的协议选择器。
   ...
   <table>
    <tbody>
      <tr>
      <td><strong>您使用的视频投放协议</strong></td>
      <td><strong>要使用的协议选择器</strong></td>
      </tr>
      <tr>
      <td><p>HTTP</p> <p>如果您使用HTTP(非安全视频投放)，请确保在您之前复制的视频服务URL值中将<code>https</code>更改为<code>http</code>。</p> </td>
