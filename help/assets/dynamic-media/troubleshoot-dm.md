...
## 新建Dynamic Media配置 {#new-dm-config}
...
<table>
 <tbody>
  ...
  <tr>
   ...
   <td>
    <ul>
     <li>检查是否已配置Dynamic Media Cloud Service。</li>
...
1. 在云服务[中重新创建](/help/assets/dynamic-media/config-dm.md#configuring-dynamic-media-cloud-services)Dynamic Media配置。
