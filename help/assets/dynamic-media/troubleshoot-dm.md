---
title: Dynamic Media疑难解答
description: Dynamic media疑难解答。
...
# Dynamic Media疑难解答 {#troubleshooting-dynamic-media-scene-mode}

以下文档介绍了Dynamic media的疑难解答。
...
* Dynamic media不支持创建版本。 新版本将替换交付中的现有资产。
