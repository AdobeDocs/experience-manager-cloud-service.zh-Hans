...
| 资源类型 | [浏览](/help/assets/navigate-view.md) | 复制 | [上传](/help/assets/add-delete.md) | 创建 | [删除](/help/assets/add-delete.md#delete-assets) | 详细信息 | 图像缩放 | [最近查看的项目](/help/assets/navigate-view.md) |
|-------------------|----------|----------|----------|----------|----------|-------------------|------------|-----------------|
| 栅格图像 | ✓ | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ |
| RAW 文件 | ✓ | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ |
| 文件夹 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | − | − |
...
| 资源类型 | [下载](/help/assets/manage-organize.md#download) | 拖放 | [图像编辑器](/help/assets/edit-images.md) | [搜索](/help/assets/search.md) | [智能标记](/help/assets/metadata.md#tags) | [重命名](/help/assets/manage-organize.md) | [版本](/help/assets/manage-organize.md#versions-of-assets) |
|---------------|----------|---------------|--------------|----------|------------|----------|----------|
| 栅格图像 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| RAW 文件 | ✓ | ✓ | − | ✓ | ✓ | ✓ | ✓ | ✓ |
| 文件夹 | ✓ | ✓ | − | ✓ | − | ✓ | ✓ |
...
| 资源类型 | [元数据](/help/assets/metadata.md) | [演绎版](/help/assets/add-delete.md#renditions) | [垃圾桶](/help/assets/add-delete.md#delete-assets) | 复制 | 移动 |
|---------------|-------------------|------------|----------|----------|----------|
| 栅格图像 | ✓ | ✓ | ✓ | ✓ | ✓ |
| RAW 文件 | ✓ | ✓ | ✓ | ✓ | ✓ |
| 文件夹 | ✓ | − | ✓ | ✓ | ✓ |
