...
>[!CAUTION]
>
>要编辑内容片段，您需 [要相应的权限](/help/implementing/developing/extending/content-fragments-customizing.md#asset-permissions)。 如果您遇到问题，请与系统管理员联系。
...
除了标准选项之外，时间 [轴还](/help/assets/manage-digital-assets.md#timeline) 提供特定于内容片段的信息和操作：
