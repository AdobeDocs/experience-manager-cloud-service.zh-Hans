...
>* 对于[使用带有GraphQL的内容片段的无外设内容投放。](/help/assets/content-fragments/content-fragments-graphql.md)
...
>[!CAUTION]
>
>要编辑内容片段，您需要[相应的权限](/help/implementing/developing/extending/content-fragments-customizing.md#asset-permissions)。 如果您遇到问题，请与系统管理员联系。
