...
1. 导航到适合您的[配置或子配置](/help/assets/content-fragments/content-fragments-configuration-browser.md)的文件夹。
1. 使用&#x200B;**“创建”**&#x200B;打开向导。
...
该消息建议您检查[引用](/help/sites-cloud/authoring/basic-handling.md#references)面板，以进一步调查：
