---
title: 新建视频查看器
description: Dynamic Media中新的视频查看器提供了增强的视频播放体验
role: User
exl-id: null
...
![拖动Dynamic Media组件](assets/drag-component.jpeg)
...
2. 单击组件工具栏中的&#x200B;**配置**。
   ![打开Dynamic Media设置](assets/configure-asset.png)

3. 在&#x200B;**Dynamic Media设置对话框**&#x200B;中，从&#x200B;**查看器预设**&#x200B;下拉列表中选择&#x200B;**视频（新）**。
   ![选择视频（新）查看器预设](assets/viewer-preset.jpeg)

4. 在&#x200B;**查看器修饰符**&#x200B;字段中输入任何必需的修饰符（例如，`autoplay=true&muted=true`）。
   ![查看器修饰符](assets/additional-modifiers.jpeg)
...
事件有效负载包括事件类型、播放状态、当前播放时间和其他元数据等信息。 这些事件可用于支持分析跟踪、自定义交互或与外部系统的集成
