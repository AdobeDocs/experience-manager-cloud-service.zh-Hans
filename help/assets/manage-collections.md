...
1. 将资产拖至“放 **[!UICONTROL 入收藏集”区]** 。 或者，点按／单击工 **[!UICONTROL 具栏中的]** “到集合”图标。
...
1. 指定集合的名称。 Select **[!UICONTROL Public]** to add the DAM Users group with the Viewer role to the smart collection.
   ...
   >[!NOTE]
   >
   >如果您选 **[!UICONTROL 择]**“公共”，则创建智能收藏集后，具有“所有者”角色的所有人都可以使用该智能收藏集。 If you deselect the **[!UICONTROL Public]** option, the DAM user group is no longer associated with the smart collection.
...
1. 选择资产，然后点按／单击工 **[!UICONTROL 具栏中的]** “收藏集”图标。 或者，您也可以将资产拖 **[!UICONTROL 放到收藏集]** 区。 当放置区域变为活动状态且其标签变为“放置到添加”时， **[!UICONTROL 松开鼠标按钮]**。
...
1. 在工具栏中，点按／单击下载图标。
1. 在“下 **[!UICONTROL 载]** ”对话框中，点按/ **[!UICONTROL 单击下载]**。 如果要下载集合中资产的演绎版，请选择“演 **[!UICONTROL 绎版]**”。 <!-- Select the **[!UICONTROL Email]** option to send an email notification to the owner of the collection. -->
...
1. 在工具栏中，点按／单 **[!UICONTROL 击属]** 性以打开 [!UICONTROL 选定集] 合的“属性”页面。
1. 修改各个选项卡下选定集合的元数据属性。

   >[!NOTE]
   >
   >您为所选集合添加的元数据将覆盖这些集合的以前元数据，但标记除外。 您在“标记”字段中添 **[!UICONTROL 加的]** 任何标记都会附加到元数据中的现有标记列表。
...
1. 从收藏集控制台中，选择所需的收藏集或收藏集组，然后点按或单 **[!UICONTROL 击工具栏]** 中的收藏集。
