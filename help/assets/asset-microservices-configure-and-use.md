...
处理用户档案可以包括FPO（仅用于放置）再现。 请参阅Adobe Asset Link [文档](https://helpx.adobe.com/enterprise/using/manage-assets-using-adobe-asset-link.html) ，了解您是否需要为处理用户档案打开它。 有关详细信息，请参 [阅Adobe Asset Link完整文档](https://helpx.adobe.com/enterprise/using/adobe-asset-link.html)。
