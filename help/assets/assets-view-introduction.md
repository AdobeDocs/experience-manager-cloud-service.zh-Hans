...
* [有助于做出以数据为驱动的决策的洞察](#insights-data)
...
为了跟上内容更新速度，可行的洞察至关重要。Assets视图在“我的Workspace”中提供高级见解，提供关于资产性能、受众使用情况和参与的宝贵数据。 营销人员可以做出以数据驱动的决策、优化内容策略并完善下游交付以实现最佳结果。通过获得有意义的洞察，企业可以在竞争中保持领先地位并取得卓越成果。

![洞察概述](assets/insights-overview.gif)
