...
从浏览器的“资产”用户界面中，您可以浏览资产位置或注销并打开资产，以便在桌面应用程序中进行编辑。 这些选项称为“桌面操作”，如果未启用这些选项，请参阅 [在AEM Web界面中启用桌面操作](https://docs.adobe.com/help/en/experience-manager-desktop-app/using/using.html#desktopactions-v2)。
