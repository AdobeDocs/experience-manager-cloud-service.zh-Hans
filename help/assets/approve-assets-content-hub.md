...
### 在Experience Manager as a Cloud Service中批准Content Hub的资产有何用途？ {#approving-assets-content-hub}

批准资源可确保在Content Hub中只能使用最新的批准版本，从而在所有渠道和应用程序中保持严格的品牌一致性。 这种受控流程可简化品牌经理和营销人员的资产管理。

### 批准Content Hub的资产需要什么先决条件？

您必须具有AEM Assets as a Cloud Service的访问权限和写入权限，才能编辑资源元数据，尤其是资源属性中的&#x200B;**状态**&#x200B;字段。

### 如何使用AEM as a Cloud Service中的Assets视图批准单个资源？

选择资产，单击工具栏中的&#x200B;**详细信息**，导航到&#x200B;**基本**&#x200B;选项卡，从&#x200B;**状态**&#x200B;下拉列表中选择&#x200B;**已批准**，然后单击&#x200B;**保存**。 该资源在Content Hub中可用。

### 能否为Content Hub批量批准资源？如果是，如何批准？

可以，资产可以批量批准。 在Assets视图中，选择多个资源，单击&#x200B;**批量元数据编辑**，在“属性”下的&#x200B;**状态**&#x200B;字段中选择&#x200B;**已批准**，然后单击&#x200B;**保存**。 所有选定的资源在Content Hub中均可用。

### Content Hub中的资源批准流程的工作原理 {#asset-approval-content-hub}

如果启用了自动审批切换，则使用Content Hub上传的资源会自动可用。 如果已禁用，则上传的资产将放在Assets as a Cloud Service的&#x200B;**hydrated-assets**&#x200B;文件夹中，您需要手动将其状态批量编辑为&#x200B;**已批准**，以便它们在Content Hub中显示。
...
### 如果您在Assets查看资源详细信息页面上看不到批准目标字段，会发生什么情况？
...
### 谁可以访问Content Hub中已批准的资源，以及已制定了哪些控制？

在Content Hub中，属于同一组织的用户可以使用批准的资源。 严格的控制确保只能访问最新的批准版本，从而帮助维护品牌一致性和安全性。
