...
| JPEG | 生成再现的JPEG格式。 |
| PNG | 生成再现的PNG格式。 |
| 宽度／高度 | 支持以像素为单位定义再现的宽度和高度。 |

### Adobe格式 {#adobe-formats}

| 文件格式 | GIF | JPEG | PNG | 全文提取 | TIFF | 元数据提取 | 宽度／高度 |
| ----------- | -------- | -------- | -------- | ------------------- | -------- | ------------------- | ------------ |
| AI | ✓ | ✓ | ✓ | - | ✓ | ✓ | ✓ |
| COLLAGE | - | - | - | - | - | ✓ | - |
| DN | ✓ | ✓ | ✓ |  | ✓ | ✓ | ✓ |
...
| 文件格式 | GIF | JPEG | PNG | TIFF | 元数据提取 | 宽度／高度 | 裁剪 |
| ----------- | -------- | -------- | -------- | -------- | ------------------- | ------------ | -------- |
| BMP | ✓ | ✓ | ✓ | ✓ | - | ✓ | ✓ |
| EPS | - | - | - | - | ✓ | - | - |
| GIF | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
| 文件格式 | GIF | JPEG | PNG | TIFF | 元数据提取 | 宽度／高度 |
| ----------- | -------- | -------- | -------- | -------- | ------------------- | ------------ |
| 3FR | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| ARW | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| CR2 | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
...
|  | GIF | JPEG | PNG | 全文提取 | TIFF | 宽度／高度 | 元数据管理 | [连接的资产](use-assets-across-connected-assets-instances.md) |
| ---- | -------- | -------- | -------- | ------------------- | -------- | ------------ | ------------------- | ------------------------------------------------------------------- |
| PDF | ✓ | ✓ | ✓ | ✓ | - | ✓ | ✓ | ✓ |
| DOCX | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ | ✓ |
| DOC | - | - | - | - | - | - | ✓ | ✓ |
