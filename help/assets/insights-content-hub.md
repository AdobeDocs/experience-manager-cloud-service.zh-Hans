...
[!DNL Content Hub] 提供了对资产的宝贵洞察，解决了营销利益相关者经常遇到的共同挑战：营销活动、渠道和不同地区使用的资产使用情况统计数据。通过清楚地了解资产的性能和受欢迎程度，它提供了对增强用户体验至关重要的可操作洞察。
...
## 常见问题解答 {#faqs-assets-insights-content-hub}

### 我们需要AEM Assets Content Hub中的Assets Insights做什么？
