...
| 复合资产的子资产生成 | 不受支持. | 可能无法满足注释等相关用例。 请参阅 [!DNL Experience Manager] 6.5](https://experienceleague.adobe.com/docs/experience-manager-65/assets/managing/managing-linked-subassets.html#generate-subassets)中的[子资产创建。 从[2021.7.0版](/help/release-notes/release-notes-cloud/release-notes-current.md)开始，可以预览某些文件类型。 |
