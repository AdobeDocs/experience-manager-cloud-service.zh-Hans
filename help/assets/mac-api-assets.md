...
有关 [如何使用API创建资产的信息](developer-reference-material-apis.md) ，请参阅资产上传。 已弃用使用HTTP API创建资产。

## 更新资产二进制 {#update-asset-binary}

有关如 [何使用API更新资产二进制文件的信息](developer-reference-material-apis.md) ，请参阅资产上传。 已弃用使用HTTP API更新资产二进制文件。
...
## 创建资产再现 {#create-an-asset-rendition}
