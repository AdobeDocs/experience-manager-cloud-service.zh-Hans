---
title: 与 [!DNL Adobe Creative Cloud]
...
* [AEM Assets品牌门户](https://helpx.adobe.com/cn/experience-manager/brand-portal/user-guide.html) ，为AEM Assets提供一个可配置的SaaS加载项来发布资产。
...
* [AEM AssetsWeb界面](/help/assets/manage-digital-assets.md) ，与由AEM访问控制设置保护的外部方的区域以及必要的IT/网络配置调整进行界面，使这些外部用户能够访问AEM。
...
* 要批量上传大型／分层文件夹，请使用提供文件夹上传功 [能的AEM桌面](https://helpx.adobe.com/experience-manager/desktop-app/aem-desktop-app.html#bulkupload) 应用程序。 您还可以上传分层文件夹结构。 资源在后台上传，因此不会绑定到Web浏览器会话
