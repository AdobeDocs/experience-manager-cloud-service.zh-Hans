...
7. 单击&#x200B;**[!UICONTROL 上传]**&#x200B;以将资源上传到AEM Assets。
   ...
   >[!NOTE]
   >
   > 如果要将资源保存到Content Hub投放存储库，则项目或营销策划名称是必填字段。 在这种情况下，您也无需选择目标文件夹，因为它是自动从元数据派生的。
...
|------------------|---------------------------------------------|---------------|
| JPEG | 65 MP(例如，8K × 8K或16K × 4K) | 80 MB台式机， 40 MB移动设备 |
| PNG | 65 MP(例如，8K × 8K或16K × 4K) | 80 MB台式机， 40 MB移动设备 |
| SVG | — | 250 KB |
| MP4 | 3840 × 3840像素 | 200 MB |
| PSD | 65 MP(例如，8K × 8K或16K × 4K) | 80 MB台式机， 40 MB移动设备 |
| PDF | — | — |
