---
title: 在AEM Assets中使用Adobe Stock数字资源
description: 在Experience Manager中搜索、提取、许可和管理Adobe Stock资源。 将许可资产视为任何其他Experience Manager资产。
contentOwner: AG
...
* 要在Adobe Stock和AEM Assets中搜索资产，请单击搜索图 ![标search_icon](assets/do-not-localize/search_icon.png)。
...
![用于许可和保存AEM Assets中的Adobe Stock资源的对话框](assets/aem-stock_licenseandsave.jpg)*图： 用于许可和保存AEM Assets中的Adobe Stock资源的对话框*
