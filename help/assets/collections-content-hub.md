...
## 常见问题解答 {#faqs-manage-collections-content-hub}

### 在AEM Assets Content Hub中，什么是收藏集？

AEM Assets Content Hub中的收藏集是指可在用户之间共享的一组资源。 收藏集可以包含来自不同位置的资源，同时保持其引用完整性。 它们为用户创建一个共享空间，以便高效地访问和利用内容。

### 如何在AEM Assets Content Hub中创建新收藏集？

要在AEM Assets Content Hub中创建新收藏集，请转到“收藏集”选项卡，然后单击&#x200B;**创建收藏集**。 在新的“收藏集”窗口中，添加标题和说明，在&#x200B;**谁可以访问**&#x200B;下拉列表中选择访问控制类型，然后单击&#x200B;**创建**。 然后，您可以将资产添加到收藏集。

### 在AEM Assets Content Hub中创建收藏集时，可以使用哪些类型的访问控制？

AEM Assets Content Hub中有三种访问控制类型： **私有** — 只有创建者和管理员才能编辑和访问，**公共** — 仅查看 — 所有人都可以查看，但只有创建者和管理员可以编辑，以及&#x200B;**公共** — 查看和编辑 — 所有人都可以访问和编辑集合，没有任何限制。

### 谁可以在AEM Assets Content Hub中对收藏集执行操作？

AEM Assets Content Hub用户可以执行创建、查看、共享、下载、删除、删除、固定收藏集和将其标记为收藏等操作。 管理员具有其他权限，例如查看所有访问选项和删除收藏集。

### 如何在AEM Assets Content Hub中将资源添加到现有收藏集？

要将资源添加到AEM Assets Content Hub中的现有收藏集，请选择要添加的资源，单击&#x200B;**添加到收藏集**，然后从列表中选择收藏集。 您还可以使用搜索栏搜索收藏集。 单击&#x200B;**添加到收藏集**&#x200B;以确认操作。

### 能否在AEM Assets Content Hub中过滤和搜索收藏集？

可以，可以在AEM Assets Content Hub中按名称、访问权限或创建者对收藏集进行过滤和搜索。 筛选器包括&#x200B;**所有收藏集**、**只有我**、**任何人都可以查看**、**任何人都可以编辑**、**由任何人创建**&#x200B;和&#x200B;**由我创建**&#x200B;等选项。

### 如何从AEM Assets Content Hub中的收藏集下载资源？

要从AEM Assets Content Hub中的收藏集下载资源，请导航到&#x200B;**收藏集**&#x200B;选项卡，然后单击收藏集卡上的下载图标来下载所有资源。 您还可以打开收藏集，选择单个资产，然后单击&#x200B;**下载**&#x200B;以单独下载它们。

### 如何从AEM Assets Content Hub中的收藏集共享资源？

通过在Assets Content Hub中启用公共链接共享，可以共享AEM Assets。 选择资产卡上的共享图标以复制共享链接，然后可将其发送给收件人。 请注意，无法共享专用收藏集。

### 谁可以从AEM Assets Content Hub中的收藏集中删除资源？

收藏集的所有者、管理员或具有编辑权限的非管理员用户可从AEM Assets Content Hub中的收藏集删除单个或多个资源。 若要删除，请选择这些资源，然后单击&#x200B;**从收藏集**&#x200B;中删除，然后确认删除。

### 谁可以从AEM Assets Content Hub中删除收藏集？这是如何完成的？

只有管理员和收藏集的创建者可以将其删除。 要删除收藏集，请导航到收藏集选项卡，选择收藏集，然后单击删除图标。 该收藏集将从AEM Assets Content Hub中删除。

### 管理员可以在AEM Assets Content Hub中为收藏集配置哪些所有选项？

管理员可以在AEM Assets Content Hub中为收藏集启用或禁用以下选项：

* 启用&#x200B;**仅查看收藏集**&#x200B;切换功能，允许所有人访问但只有创建者和管理员才能编辑的收藏集。

* 启用&#x200B;**公共收藏集**&#x200B;切换功能，以允许所有人都可以访问和编辑收藏集。 如果禁用&#x200B;**仅查看收藏集**&#x200B;和&#x200B;**公共收藏集**&#x200B;切换，则默认情况下，非管理员用户只能创建专用收藏集。
