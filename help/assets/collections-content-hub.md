...
有三种访问控制类型： **私有** — 只有创建者和管理员可以编辑和访问，**公共** — 仅查看 — 所有人都可以查看，但只有创建者和管理员可以编辑，以及&#x200B;**公共** — 查看和编辑 — 所有人都可以访问和编辑集合，没有任何限制。

### 谁可以在Content Hub中对收藏集执行操作？

Content Hub用户可以执行创建、查看、共享、下载、删除、删除、固定收藏集和将其标记为收藏等操作。 管理员具有其他权限，例如查看所有访问选项和删除收藏集。

### 如何在AEM Assets Content Hub中将资源添加到现有收藏集？

选择要添加的资源，单击&#x200B;**添加到收藏集**，然后从列表中选择收藏集。 您还可以使用搜索栏搜索收藏集。 单击&#x200B;**添加到收藏集**&#x200B;以确认操作。
...
通过在Content Hub中启用公共链接共享，可以共享Assets。 选择资产卡上的共享图标以复制共享链接，然后可将其发送给收件人。 请注意，无法共享专用收藏集。

### 谁可以从AEM Assets Content Hub中的收藏集中删除资源？

收藏集的所有者、管理员或具有编辑权限的非管理员用户可以从收藏集中删除单个或多个资产。 若要删除，请选择这些资源，然后单击&#x200B;**从收藏集**&#x200B;中删除，然后确认删除。
