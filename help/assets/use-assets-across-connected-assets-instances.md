...
1. 将AEM Sites实例添加为远程AEM资 **[!UICONTROL 产的]** CORS配置上允许的源实例之一。
   ...
   1. 要为AEM Sites实例创建CORS配置，请单击 ![Adobe Granite Cross-Origin Resource Sharing Policy(](assets/do-not-localize/aem_assets_add_icon.png) Adobe Granite跨源资源共享策略)旁边的 **[!UICONTROL aem_assets_add_icon]**&#x200B;图标。
