...
AEM作为云服务，为Experience Manager Sites和Assets提供了可扩展、安全、灵活的技术基础，使营销人员和IT人员能够专注于大规模提供有影响力的体验。

将AEM作为云服务，您的团队可以专注于创新而不是规划产品升级。 新产品功能经过全面测试并可以无中断地提供给您的团队，使他们始终能够访问最新应用程序。

## 了解云服务流程的过渡 {#understanding-move}

过渡到云服务的旅程包括三个阶段——规划、执行和上线后。

要获得成功而顺利的过渡，您应确保进行适当的规划并遵守本指南中概述的最佳实践。

下图显示了推荐的云服务过渡旅程的图示。

![图像](/help/move-to-cloud-service/assets/home-img1.png)

进一步了解云服务过渡旅程中涉及的不同阶段：
...
| [《 Moving to AEM a Cloud Service User Guide》（作为云服务用户指南转到AEM）](/help/move-to-cloud-service/home.md) | 了解过渡到云服务的旅程。 |
