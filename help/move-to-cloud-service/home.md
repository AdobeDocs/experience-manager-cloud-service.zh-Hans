---
title: 以云服务的形式转到AEM
description: Adobe Experience Manager作为云服务，以云服务自助资源和文档链接的形式转向AEM
...
本页列出了有关作为云服务转到Experience Manager的自助资源。

## 将AEM作为云服务文章移至AEM的密钥 {#key-articles}
...
| [作为云服务用户指南移至AEM](/help/move-to-cloud-service/home.md) | 了解有助于将AEM作为云服务迁移到AEM的工具。 |

## 其他 Experience Manager 资源 {#other-resources}

* [调度程序文档](/help/implementing/dispatcher/overview.md)
* [HTL 文档](https://docs.adobe.com/content/help/en/experience-manager-htl/using/overview.html)
