...
# 翻译无标题内容 {#translate-content}

使用翻译连接器翻译无头内容。

## 迄今为止的故事 {#story-so-far}

在AEM无头翻译历程的上一文档中， [配置翻译连接器](configure-connector.md) 您在AEM中了解了翻译框架。 您现在应：
...
自动创建翻译项目时，AEM会评估您选择的路径下的无标题内容。 基于该评估，它将需要翻译的内容提取到新的翻译项目中。我知道根据标记为 **可翻译** 由内容架构师负责。
