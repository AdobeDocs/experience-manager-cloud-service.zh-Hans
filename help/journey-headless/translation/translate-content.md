...
1. 导航到 **导航** > **资产** > **文件**. 请记住，AEM 中的 Headless 内容将存储为称作内容片段的资源。
...
1. 选中行项目的选择复选框可查看更多选项，例如，从作业中删除行项目或在内容片段或资产控制台中查看行项目的选项。
...
选择该图标可在其编辑器控制台中打开已翻译内容片段，以查看已翻译内容的详细信息。
...
如果您通过以下方式导航到此文件夹 **导航** > **文件** > **资产**，您将看到翻译的内容。
