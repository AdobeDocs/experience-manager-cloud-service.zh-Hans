...
1. 请记住，内容片段作为资源存储在 AEM 中。选择&#x200B;**资源**&#x200B;选项卡。
...
1. 提供以下信息。
   ...
   1. **为翻译启用内容模型字段** - 选中此选项以使翻译配置自动根据&#x200B;**可翻译**&#x200B;标志识别内容模型中的字段。
...
1. 选择&#x200B;**云服务**&#x200B;选项卡。
1. 在&#x200B;**添加配置**&#x200B;下拉列表中的&#x200B;**云服务配置**&#x200B;下，选择您的连接器。当您如[以前所述](#connect-translation-provider)安装该连接器的包后，该连接器应显示在下拉列表中。
...
在此知识的基础上继续您的 AEM Headless 翻译历程，接下来查看文档[翻译内容](translation-rules.md)，其中您将了解如何使用目前的配置实际翻译内容。
