...
>
>Microsoft Translator连接器的试用许可证不用于生产目的，如果您决定对其进行许可，系统管理员必须执行 [其他资源](#additional-resources) 部分，以便您可以配置该许可证。
...
1. 提供以下信息。
   ...
   1. **禁用仅更新翻译** – 选中此选项后，更新翻译项目将提交所有可翻译的字段以供翻译，而非仅提交自上次翻译以来更改的字段。更新翻译项目将在本历程的后面部分讨论。
