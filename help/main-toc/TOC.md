...
+ Headless {#headless}
   ...
   + 内容片段选择器{#content-fragment-selector}
      + [微前端内容片段选择器 — 概述](/help/headless/content-fragment-selector/content-fragment-selector-overview.md)
      + [内容片段选择器 — 相关属性](/help/headless/content-fragment-selector/content-fragment-selector-properties.md)
...
+ 实施 {#implementing}
   ...
   + 针对 AEM as a Cloud Service 进行开发 {#developing}
      ...
      + 混合和 SPA 开发 {#hybrid}
         ...
         + [弃用SPA编辑器](/help/implementing/developing/hybrid/spa-editor-deprecation.md)
   ...
   + 配置和扩展 AEM as a Cloud Service {#configuring-and-extending}
      ...
      + [扩展和Extension Manager](/help/implementing/developing/extending/extension-manager.md)
