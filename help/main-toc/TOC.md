...
+ AEM 中的 AI {#ai-in-aem}
   ...
   + AEM业务代理 {#business-agents}
      + [概述](/help/ai-in-aem/agents/overview.md)
      + 生产代理 {#production}
         + [概述](/help/ai-in-aem/agents/production/overview.md)
         + [交互式通信创建技能](/help/ai-in-aem/agents/production/communications-creation.md)
      ...
      + 内容优化代理 {#content-optimization}
         + [使用内容优化代理](/help/ai-in-aem/agents/content-optimization/using.md)
      + 发现代理 {#discovery}
         + [使用发现代理](/help/ai-in-aem/agents/discovery/using.md)
      + 开发代理 {#development}
