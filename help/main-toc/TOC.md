...
+ AEM 中的 AI {#ai-in-aem}
   ...
   + AEM中的代理 {#agents}
      ...
      + Experience Modalization Agent {#modernization}
         + [概述](/help/ai-in-aem/agents/modernization/overview.md)
         + [快速入门](/help/ai-in-aem/agents/modernization/getting-started.md)
         + [现代化控制台](/help/ai-in-aem/agents/modernization/console.md)
   + AI 助手 {#ai-assistant}
