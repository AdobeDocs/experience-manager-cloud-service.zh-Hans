...
您还可以从AEM实例下载最佳实践分析器报告。 参见 [查看Best Practices Analyzer报告](/help/journey-migration/best-practices-analyzer/using-best-practices-analyzer.md#viewing-report) 了解更多详细信息。
