...
Cloud Acceleration Manager (CAM)提供了一站式迁移体验。 它以引导式历程的形式提供，提供初始评估，引导他们查看正确的工具、文档和最佳实践，以确保AEM as a Cloud Service成功上线。
...
1. 从&#x200B;**Cloud Acceleration Manager**&#x200B;卡中单击&#x200B;**启动**，以便打开登陆页面。
...
1. 该项目现已创建并显示在&#x200B;**Cloud Acceleration Manager**&#x200B;登陆页面上。
...
1. 您可以编辑项目名称、描述，甚至可以从&#x200B;**编辑项目**&#x200B;对话框中上传新图像或编辑现有图像。
...
1. 单击&#x200B;**删除**&#x200B;以确认该步骤。
   ...
   >[!NOTE]
   >项目将在1年迁移非活动状态后自动过期并删除。 通过编辑项目名称或描述、上传BPA报告、创建或编辑迁移集、运行提取或运行引入，项目将保持活动状态。
