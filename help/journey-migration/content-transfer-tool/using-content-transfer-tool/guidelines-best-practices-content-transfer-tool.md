...
* 对[源](https://experienceleague.adobe.com/docs/experience-manager-65/deploying/deploying/revision-cleanup.html)存储库运行[修订清理](https://experienceleague.adobe.com/docs/experience-cloud-kcs/kbarticles/KA-16550.html)和&#x200B;**数据存储一致性检查**，以便识别潜在问题并降低存储库的大小。
