...
* 名称长度超过150个字符的JCR节点
* 大于16 MB的JCR节点
* AEM as a Cloud Service上已存在任何已摄取`rep:AuthorizableID`的用户/组
...
了解如何迁移到AEM as a Cloud Service后，您可以检查[Post-Go-Live](/help/journey-migration/post-go-live.md)页面以保持实例平稳运行。
