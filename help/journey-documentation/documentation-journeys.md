...
文档历程是基于最佳实践的介绍，介绍 AEM 如何解决常见业务问题。 因此，每个历程的设计都考虑了 AEM 的新读者，列出了业务问题，描述了任何必要的理论，然后逐步概述了 AEM 如何解决该问题。 由于旅程的综合性，它对于初次接触AEM的读者以及经验丰富的用户很有用。
...
您已经可以使用许多文档历程。 由于每个历程都设计为叙述性的，因此请从简介开始，并通读一遍，以便您可以在AEM的上下文中充分了解该主题。
