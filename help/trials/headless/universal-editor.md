...
1. 默认情况下，该编辑器应加载到 **组件** 模式。 如果没有，请点按或单击 **组件** 图标（位于编辑器左侧的模式边栏中）。

1. 双击或单击最新文章的标题可对其进行编辑。
...
1. 剩余时间 **组件** 模式，点按或单击冲浪者的图像以将其选定。

1. 在组件边栏中，您可以查看资源的详细信息。点按或单击 **特色图像** 缩略图。
...
1. 此 **编辑** 图标将出现在组件边栏中。 点按或单击&#x200B;**编辑**&#x200B;图标以在新标签页上打开内容片段编辑器。
